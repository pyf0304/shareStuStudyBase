/**
 * 类名:CurrEduClsStu_EditEx(界面:CurrEduClsStuCRUD,01120075)
 * 表名:CurrEduClsStu(01120125)
 * 版本:2024.11.10.1(服务器:WIN-SRV103-116)
 * 日期:2024/11/10 16:37:35
 * 生成者:
 工程名称:问卷调查(0112)
...
*/
export default class CurrEduClsStu_EditEx extends CurrEduClsStu_Edit {
  /**
 ...
 **/
  public static btnEdit_Click(strCommandName: string, strKeyId: string) {
    ...
    const objPage: CurrEduClsStu_EditEx = <CurrEduClsStu_EditEx>(
      CurrEduClsStu_Edit.GetPageEditObj('CurrEduClsStu_EditEx')
    );
    if (objPage == null) {
      const strMsg = `从预存编辑类获取关键字:[CurrEduClsStu_EditEx]的对象为空，请在调用编辑类(父类)的定义一下！`;
