...
<script lang="ts">
  ...
  import { refDivEdit, CourseId_Session } from '@/viewsShare/DailyRunning/CurrEduClsStuVueShare';
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      async function GetEditDataCurrEduClsStuObj() {
        ...
        pobjCurrEduClsStuEN.SetIdCurrEduCls(idCurrEduCls.value); // 教学班
        pobjCurrEduClsStuEN.SetIdStu(idStu.value); // 学生
        pobjCurrEduClsStuEN.SetSchoolTerm(schoolTerm.value); // 学期
        pobjCurrEduClsStuEN.SetSchoolYear(schoolYear.value); // 学年
      ...
      async function ShowDataFromCurrEduClsStuObj(pobjCurrEduClsStuEN: clsCurrEduClsStuEN) {
        idCurrEduCls.value = pobjCurrEduClsStuEN.idCurrEduCls; // 教学班
        idStu.value = pobjCurrEduClsStuEN.idStu; // 学生
        schoolTerm.value = pobjCurrEduClsStuEN.schoolTerm; // 学期
        schoolYear.value = pobjCurrEduClsStuEN.schoolYear; // 学年
