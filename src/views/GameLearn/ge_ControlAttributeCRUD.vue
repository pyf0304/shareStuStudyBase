  ...
  <div id="divLayout" ref="refDivLayout" class="div_layout">
      ...
      >
        <tbody>
          <tr>
            ...
            <td class="text-right">
              <label
                id="lblControlAttributeName_q"
                name="lblControlAttributeName_q"
                class="col-form-label text-right"
                style="width: 90px"
                >属性名称
              </label>
            ...
            <td class="text-left">
              <input
                id="txtControlAttributeName_q"
                v-model="controlAttributeName_q"
                class="form-control form-control-sm"
                style="width: 120px"
              />
            </td>
    ...
    <div id="divFunction" ref="refDivFunction" class="table table-bordered table-hover">
      <ul class="nav">
        <li class="nav-item">
          <label
            id="lblge_ControlAttributeList"
            name="lblge_ControlAttributeList"
...
<script lang="ts">
  ...
  import ge_ControlAttribute_EditCom from '@/viewsShare/GameLearn/ge_ControlAttribute_Edit.vue';
  import ge_ControlAttribute_ListCom from '@/viewsShare/GameLearn/ge_ControlAttribute_List.vue';
  export default defineComponent({
    ...
    setup() {
      const objPage = ref<ge_ControlAttributeCRUDEx>();
      const objPage_Edit = ref<ge_ControlAttribute_EditEx>();
      const opType = ref('');
      const thisConstructorName = 'Ge_ControlAttributeCRUD';
      ...
      const btnQuery_Click = async () => {
        ...
        await objPage.value.BindGv_ge_ControlAttributeCache(refDivList.value);
      };
      ...
      const btnCreate_Click = async () => {
        ...
        objPage_Edit.value = new ge_ControlAttribute_EditEx(
          'ge_ControlAttribute_EditEx',
          objPage.value,
        );
        ...
        try {
          opType.value = 'Add';
          const bolIsSuccess = await objPage_Edit.value.ShowDialog_ge_ControlAttribute(
            opType.value,
          );
      ...
      const btnUpdate_Click = async () => {
        ...
        const strAttributeId = GetFirstCheckedKeyIdInDivObj(divVarSet.refDivList);
        ...
        try {
          ...
          if (bolIsSuccess == false) return;
          const update = await objPage_Edit.value.UpdateRecord(strAttributeId);
          if (update == false) {
      ...
      const btnDelete_Click = async () => {
        ...
        try {
          ...
          await objPage.value.BindGv_ge_ControlAttributeCache(divVarSet.refDivList);
        } catch (e) {
      ...
      const btnExportExcel_Click = async () => {
        ...
        await objPage.value.ExportExcel_ge_ControlAttributeCache();
      };
      ...
      onMounted(async () => {
        ...
        objPage.value = new ge_ControlAttributeCRUDEx();
