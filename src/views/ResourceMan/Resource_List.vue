...
<th @click = "sortColumn('fileRename')">
文件新名
<span>
<i :class="sortColumnKey === 'fileRename'? (sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'):'arrow-neutral'"></i>
</span>
</th>
...
文件名称
<span>
<i :class="sortColumnKey === 'fileName'? (sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'):'arrow-neutral'"></i>
</span>
</th>

<th @click = "sortColumn('resourceTypeName')">
资源类型名称
<span>
<i :class="sortColumnKey === 'resourceTypeName'? (sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'):'arrow-neutral'"></i>
</span>
</th>
...
功能模块名称
<span>
<i :class="sortColumnKey === 'funcModuleName'? (sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'):'arrow-neutral'"></i>
</span>
</th>
...
<td v-html="item.resourceName"></td>

<td v-html="item.saveMode"></td>

<td v-html="item.idFtpResource"></td>

<td v-html="item.idFile"></td>

<td v-html="item.idResourceType"></td>

<td v-html="item.updDate"></td>

<td v-html="item.funcModuleId"></td>

<td v-html="item.checkDate"></td>

<td v-html="item.checkUser"></td>

<td v-html="item.checkResult"></td>
