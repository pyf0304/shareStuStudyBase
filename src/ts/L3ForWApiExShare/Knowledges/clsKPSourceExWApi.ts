...
import { KPSource_SortFunByKey } from "@/ts/L3ForWApi/Knowledges/clsKPSourceWApi";
...
{
const strMsg = Format("(errid:Watl000067)Copy表对象数据出错,{0}.(in {1}.{2})", e, kPSourceEx_ConstructorName, strThisFuncName);
