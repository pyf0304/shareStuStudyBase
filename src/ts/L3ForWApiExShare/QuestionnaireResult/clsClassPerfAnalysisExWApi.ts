...
import { ClassPerfAnalysis_GetObjLstByPagerAsync,ClassPerfAnalysis_SortFunByKey,ClassPerfAnalysis_FilterFunByKey } from "@/ts/L3ForWApi/QuestionnaireResult/clsClassPerfAnalysisWApi";
import { vQuestionnaire_Sim_func,vQuestionnaire_Sim_funcKey } from "@/ts/L3ForWApi/QuestionaireEdit/clsvQuestionnaire_SimWApi";
...
import { QuestionType_func,QuestionType_funcKey } from "@/ts/L3ForWApi/SystemSet/clsQuestionTypeWApi";
import { clsQuestionTypeEN } from "@/ts/L0Entity/SystemSet/clsQuestionTypeEN";
import { ge_DifficultyLevel_func,ge_DifficultyLevel_funcKey } from "@/ts/L3ForWApi/SystemSet/clsge_DifficultyLevelWApi";
...
export const classPerfAnalysisExController = "ClassPerfAnalysisExApi";
 ...
 **/
export  function ClassPerfAnalysisEx_CopyToEx(objClassPerfAnalysisENS:clsClassPerfAnalysisEN ): clsClassPerfAnalysisENEx
{
...
{
const strMsg = Format("(errid:Watl000067)Copy表对象数据出错,{0}.(in {1}.{2})", e, classPerfAnalysisEx_ConstructorName, strThisFuncName);
 ...
 * @returns 对象列表
*/
export  async function ClassPerfAnalysisEx_GetObjExLstByPagerAsync(objPagerPara: stuPagerPara):Promise<Array<clsClassPerfAnalysisENEx>> {
...
arrClassPerfAnalysisSel = arrClassPerfAnalysisSel.sort(ClassPerfAnalysisEx_SortFunByKey(strSortFld, strSortType));
}
else {
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]获取分页对象列表不成功!(In {2}.{3})", e, objPagerPara.whereCond, classPerfAnalysisEx_ConstructorName, strThisFuncName);
console.error(strMsg);
 ...
 **/
export  async function ClassPerfAnalysisEx_FuncMapQuestionName(objClassPerfAnalysis:clsClassPerfAnalysisENEx )
{
...
if (IsNullOrEmpty(objClassPerfAnalysis.questionName) == true){
 ...
 const vQuestionnaireSimQuestionName = await vQuestionnaire_Sim_func(clsvQuestionnaire_SimEN.con_QuestionId, clsvQuestionnaire_SimEN.con_QuestionName, vQuestionnaireSimQuestionId , objClassPerfAnalysis.courseId);
 objClassPerfAnalysis.questionName = vQuestionnaireSimQuestionName;
}
}
catch (e)
{
const strMsg = Format("(errid:Watl000896)函数映射表对象数据出错,{0}.(in {1}.{2})", e, classPerfAnalysisEx_ConstructorName, strThisFuncName);
console.error(strMsg);
alert(strMsg);
}
}
 ...
 * @param objClassPerfAnalysisS:源对象
 **/
export  async function ClassPerfAnalysisEx_FuncMapCourseName(objClassPerfAnalysis:clsClassPerfAnalysisENEx )
{
...
{
const strMsg = Format("(errid:Watl000535)函数映射表对象数据出错,{0}.(in {1}.{2})", e, classPerfAnalysisEx_ConstructorName, strThisFuncName);
console.error(strMsg);
alert(strMsg);
}
}
 ...
 * @param objClassPerfAnalysisS:源对象
 **/
export  async function ClassPerfAnalysisEx_FuncMapQuestionTypeName(objClassPerfAnalysis:clsClassPerfAnalysisENEx )
{
...
if (IsNullOrEmpty(objClassPerfAnalysis.questionTypeName) == true){
 const vQuestionnaireSimQuestionId = objClassPerfAnalysis.questionId.toString();
 const vQuestionnaireSimQuestionTypeId = await vQuestionnaire_Sim_func(clsvQuestionnaire_SimEN.con_QuestionId, clsvQuestionnaire_SimEN.con_QuestionTypeId, vQuestionnaireSimQuestionId , objClassPerfAnalysis.courseId);
 const QuestionTypeQuestionTypeId = vQuestionnaireSimQuestionTypeId;
 const QuestionTypeQuestionTypeName = await QuestionType_func(clsQuestionTypeEN.con_QuestionTypeId, clsQuestionTypeEN.con_QuestionTypeName, QuestionTypeQuestionTypeId );
 objClassPerfAnalysis.questionTypeName = QuestionTypeQuestionTypeName;
}
}
catch (e)
{
const strMsg = Format("(errid:Watl000913)函数映射表对象数据出错,{0}.(in {1}.{2})", e, classPerfAnalysisEx_ConstructorName, strThisFuncName);
console.error(strMsg);
alert(strMsg);
}
}
 ...
 * @param objClassPerfAnalysisS:源对象
 **/
export  async function ClassPerfAnalysisEx_FuncMapDifficultyLevelName(objClassPerfAnalysis:clsClassPerfAnalysisENEx )
{
...
if (IsNullOrEmpty(objClassPerfAnalysis.difficultyLevelName) == true){
 const vQuestionnaireSimQuestionId = objClassPerfAnalysis.questionId.toString();
 const vQuestionnaireSimDifficultyLevelId = await vQuestionnaire_Sim_func(clsvQuestionnaire_SimEN.con_QuestionId, clsvQuestionnaire_SimEN.con_DifficultyLevelId, vQuestionnaireSimQuestionId , objClassPerfAnalysis.courseId);
 const geDifficultyLevelDifficultyLevelId = vQuestionnaireSimDifficultyLevelId;
 const geDifficultyLevelDifficultyLevelName = await ge_DifficultyLevel_func(clsge_DifficultyLevelEN.con_DifficultyLevelId, clsge_DifficultyLevelEN.con_DifficultyLevelName, geDifficultyLevelDifficultyLevelId );
 objClassPerfAnalysis.difficultyLevelName = geDifficultyLevelDifficultyLevelName;
}
}
catch (e)
{
const strMsg = Format("(errid:Watl000925)函数映射表对象数据出错,{0}.(in {1}.{2})", e, classPerfAnalysisEx_ConstructorName, strThisFuncName);
console.error(strMsg);
alert(strMsg);
}
}
 ...
 * @param objClassPerfAnalysisS:源对象
 **/
export  async function ClassPerfAnalysisEx_FuncMapDifficultyLevelId(objClassPerfAnalysis:clsClassPerfAnalysisENEx )
{
...
{
const strMsg = Format("(errid:Watl000995)函数映射表对象数据出错,{0}.(in {1}.{2})", e, classPerfAnalysisEx_ConstructorName, strThisFuncName);
console.error(strMsg);
alert(strMsg);
}
}
 ...
 * @param objClassPerfAnalysisS:源对象
 **/
export  async function ClassPerfAnalysisEx_FuncMapQuestionTypeId(objClassPerfAnalysis:clsClassPerfAnalysisENEx )
{
...
{
const strMsg = Format("(errid:Watl000916)函数映射表对象数据出错,{0}.(in {1}.{2})", e, classPerfAnalysisEx_ConstructorName, strThisFuncName);
console.error(strMsg);
alert(strMsg);
}
}
 ...
 * @param objClassPerfAnalysisS:源对象
 **/
export  async function ClassPerfAnalysisEx_FuncMapSchoolName(objClassPerfAnalysis:clsClassPerfAnalysisENEx )
{
...
{
const strMsg = Format("(errid:Watl000621)函数映射表对象数据出错,{0}.(in {1}.{2})", e, classPerfAnalysisEx_ConstructorName, strThisFuncName);
console.error(strMsg);
alert(strMsg);
}
}
 ...
 * @param objClassPerfAnalysisS:源对象
 **/
export  async function ClassPerfAnalysisEx_FuncMapEduClsName(objClassPerfAnalysis:clsClassPerfAnalysisENEx )
{
...
if (IsNullOrEmpty(objClassPerfAnalysis.eduClsName) == true){
 ...
 const vCurrEduClsSimEduClsName = await vCurrEduCls_Sim_func(clsvCurrEduCls_SimEN.con_IdCurrEduCls, clsvCurrEduCls_SimEN.con_EduClsName, vCurrEduClsSimIdCurrEduCls , objClassPerfAnalysis.courseId);
 objClassPerfAnalysis.eduClsName = vCurrEduClsSimEduClsName;
}
}
catch (e)
{
const strMsg = Format("(errid:Watl000534)函数映射表对象数据出错,{0}.(in {1}.{2})", e, classPerfAnalysisEx_ConstructorName, strThisFuncName);
console.error(strMsg);
alert(strMsg);
}
}
...
*/
export  function ClassPerfAnalysisEx_FuncMapByFldName(strFldName: string, objClassPerfAnalysisEx: clsClassPerfAnalysisENEx)
{
 ...
 * @param objClassPerfAnalysisS:源对象
 **/
export  async function ClassPerfAnalysisEx_FuncMapKeyQuestionName(objClassPerfAnalysis:clsClassPerfAnalysisENEx ): Promise<Array<number>>
{
...
if (IsNullOrEmpty(objClassPerfAnalysis.questionName) == true) return [];
 ...
 const arrQuestionId = await vQuestionnaire_Sim_funcKey(clsvQuestionnaire_SimEN.con_QuestionName, vQuestionnaireSimQuestionName , objClassPerfAnalysis.courseId, enumComparisonOp.Like_03);
 return arrQuestionId;
}
catch (e)
{
const strMsg = Format("(errid:Watl000898)函数映射表对象数据出错,{0}.(in {1}.{2})", e, classPerfAnalysisEx_ConstructorName, strThisFuncName);
console.error(strMsg);
alert(strMsg);
throw (strMsg);
}
 ...
 * @param objClassPerfAnalysisS:源对象
 **/
export  async function ClassPerfAnalysisEx_FuncMapKeyCourseName(objClassPerfAnalysis:clsClassPerfAnalysisENEx ): Promise<Array<string>>
{
...
{
const strMsg = Format("(errid:Watl000541)函数映射表对象数据出错,{0}.(in {1}.{2})", e, classPerfAnalysisEx_ConstructorName, strThisFuncName);
console.error(strMsg);
alert(strMsg);
throw (strMsg);
}
 ...
 * @param objClassPerfAnalysisS:源对象
 **/
export  async function ClassPerfAnalysisEx_FuncMapKeyQuestionTypeName(objClassPerfAnalysis:clsClassPerfAnalysisENEx ): Promise<Array<number>>
{
...
if (IsNullOrEmpty(objClassPerfAnalysis.questionTypeName) == true) return [];
 ...
 const arrQuestionTypeId = await QuestionType_funcKey(clsQuestionTypeEN.con_QuestionTypeName, QuestionTypeQuestionTypeName , enumComparisonOp.Like_03);
 const strQuestionTypeIdLst = arrQuestionTypeId;
 const arrQuestionId = await vQuestionnaire_Sim_funcKey(clsvQuestionnaire_SimEN.con_QuestionTypeId, strQuestionTypeIdLst , objClassPerfAnalysis.courseId, enumComparisonOp.In_04);
 return arrQuestionId;
}
catch (e)
{
const strMsg = Format("(errid:Watl000919)函数映射表对象数据出错,{0}.(in {1}.{2})", e, classPerfAnalysisEx_ConstructorName, strThisFuncName);
console.error(strMsg);
alert(strMsg);
throw (strMsg);
}
 ...
 * @param objClassPerfAnalysisS:源对象
 **/
export  async function ClassPerfAnalysisEx_FuncMapKeyDifficultyLevelName(objClassPerfAnalysis:clsClassPerfAnalysisENEx ): Promise<Array<number>>
{
...
if (IsNullOrEmpty(objClassPerfAnalysis.difficultyLevelName) == true) return [];
 ...
 const arrDifficultyLevelId = await ge_DifficultyLevel_funcKey(clsge_DifficultyLevelEN.con_DifficultyLevelName, geDifficultyLevelDifficultyLevelName , enumComparisonOp.Like_03);
 const strDifficultyLevelIdLst = arrDifficultyLevelId;
 const arrQuestionId = await vQuestionnaire_Sim_funcKey(clsvQuestionnaire_SimEN.con_DifficultyLevelId, strDifficultyLevelIdLst , objClassPerfAnalysis.courseId, enumComparisonOp.In_04);
 return arrQuestionId;
}
catch (e)
{
const strMsg = Format("(errid:Watl000928)函数映射表对象数据出错,{0}.(in {1}.{2})", e, classPerfAnalysisEx_ConstructorName, strThisFuncName);
console.error(strMsg);
alert(strMsg);
throw (strMsg);
}
 ...
 * @param objClassPerfAnalysisS:源对象
 **/
export  async function ClassPerfAnalysisEx_FuncMapKeyDifficultyLevelId(objClassPerfAnalysis:clsClassPerfAnalysisENEx ): Promise<Array<number>>
{
...
if (IsNullOrEmpty(objClassPerfAnalysis.difficultyLevelId) == true) return [];
 ...
 const arrQuestionId = await vQuestionnaire_Sim_funcKey(clsvQuestionnaire_SimEN.con_DifficultyLevelId, vQuestionnaireSimDifficultyLevelId , objClassPerfAnalysis.courseId, enumComparisonOp.Like_03);
 return arrQuestionId;
}
catch (e)
{
const strMsg = Format("(errid:Watl000996)函数映射表对象数据出错,{0}.(in {1}.{2})", e, classPerfAnalysisEx_ConstructorName, strThisFuncName);
console.error(strMsg);
alert(strMsg);
throw (strMsg);
}
 ...
 * @param objClassPerfAnalysisS:源对象
 **/
export  async function ClassPerfAnalysisEx_FuncMapKeyQuestionTypeId(objClassPerfAnalysis:clsClassPerfAnalysisENEx ): Promise<Array<number>>
{
...
if (IsNullOrEmpty(objClassPerfAnalysis.questionTypeId) == true) return [];
 ...
 const arrQuestionId = await vQuestionnaire_Sim_funcKey(clsvQuestionnaire_SimEN.con_QuestionTypeId, vQuestionnaireSimQuestionTypeId , objClassPerfAnalysis.courseId, enumComparisonOp.Like_03);
 return arrQuestionId;
}
catch (e)
{
const strMsg = Format("(errid:Watl000922)函数映射表对象数据出错,{0}.(in {1}.{2})", e, classPerfAnalysisEx_ConstructorName, strThisFuncName);
console.error(strMsg);
alert(strMsg);
throw (strMsg);
}
 ...
 * @param objClassPerfAnalysisS:源对象
 **/
export  async function ClassPerfAnalysisEx_FuncMapKeySchoolName(objClassPerfAnalysis:clsClassPerfAnalysisENEx ): Promise<Array<string>>
{
...
{
const strMsg = Format("(errid:Watl000627)函数映射表对象数据出错,{0}.(in {1}.{2})", e, classPerfAnalysisEx_ConstructorName, strThisFuncName);
console.error(strMsg);
alert(strMsg);
throw (strMsg);
}
 ...
 * @param objClassPerfAnalysisS:源对象
 **/
export  async function ClassPerfAnalysisEx_FuncMapKeyEduClsName(objClassPerfAnalysis:clsClassPerfAnalysisENEx ): Promise<Array<string>>
{
...
if (IsNullOrEmpty(objClassPerfAnalysis.eduClsName) == true) return [];
 ...
 const arrIdCurrEduCls = await vCurrEduCls_Sim_funcKey(clsvCurrEduCls_SimEN.con_EduClsName, vCurrEduClsSimEduClsName , objClassPerfAnalysis.courseId, enumComparisonOp.Like_03);
 return arrIdCurrEduCls;
}
catch (e)
{
const strMsg = Format("(errid:Watl000540)函数映射表对象数据出错,{0}.(in {1}.{2})", e, classPerfAnalysisEx_ConstructorName, strThisFuncName);
console.error(strMsg);
alert(strMsg);
throw (strMsg);
}
