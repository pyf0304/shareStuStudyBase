...
export const qxDepartmentInfoEx_Controller = 'QxDepartmentInfoExApi';
export const qxDepartmentInfoEx_ConstructorName = 'qxDepartmentInfoEx';
 ...
 **/
export function QxDepartmentInfoEx_GetWebApiUrl(strController: string, strAction: string): string {
 ...
 **/
export function QxDepartmentInfoEx_CopyToEx(
  objQxDepartmentInfoENS: clsQxDepartmentInfoEN,
): clsQxDepartmentInfoENEx {
  const strThisFuncName = QxDepartmentInfoEx_CopyToEx.name;
  ...
  try {
    ...
    const strMsg = Format(
      ...
      e,
      qxDepartmentInfoEx_ConstructorName,
      strThisFuncName,
    );
 ...
 * @returns 对象列表
 */
export async function QxDepartmentInfoEx_GetObjExLstByPagerAsync(
  ...
  const arrQxDepartmentInfoExObjLst = arrQxDepartmentInfoObjLst.map(QxDepartmentInfoEx_CopyToEx);
