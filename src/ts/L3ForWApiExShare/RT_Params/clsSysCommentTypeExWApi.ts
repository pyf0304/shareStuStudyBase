...
import {
  ...
  SysCommentType_GetObjLstByPagerAsync,
...
export const sysCommentTypeExController = 'SysCommentTypeExApi';
...
export async function SysCommentTypeEx_GetObjExLstByPagerAsync(
  ...
  const arrSysCommentTypeObjLst = await SysCommentType_GetObjLstByPagerAsync(objPagerPara);
