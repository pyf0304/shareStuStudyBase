...
import {
  RecommendedDegree_GetObjLstCache,
  RecommendedDegree_GetObjLstByPagerAsync,
  RecommendedDegree_SortFunByKey,
} from '@/ts/L3ForWApi/SenateGaugePara/clsRecommendedDegreeWApi';
...
export async function RecommendedDegreeEx_GetObjExLstByPagerAsync(
  ...
  try {
    if (objPagerPara.orderBy != null && objPagerPara.orderBy.length > 0) {
      ...
      arrRecommendedDegreeSel = arrRecommendedDegreeSel.sort(
