 ...
 * Created by pyf on 2023年12月21日.
 * 注意:该类必须与调用界面处于同一个包,否则调用不成功!
 **/
import { ObjectAssign, GetSortExpressInfo, GetObjKeys } from '@/ts/PubFun/clsCommFunc4Web';
import {
  XzGrade_GetObjLstCache,
  XzGrade_GetObjLstAsync,
  XzGrade_SortFunByKey,
 ...
 * @returns 对象列表
 */
export async function XzGradeEx_GetObjExLstByPagerAsync(
  objPagerPara: stuPagerPara,
): Promise<Array<clsXzGradeENEx>> {
  ...
  if (
    ...
    clsXzGradeEN.AttributeName.indexOf(objSortInfo.SortFld) == -1
  ) {
