...
export const qxDepartmentTypeEx_Controller = 'QxDepartmentTypeExApi';
 ...
 * @returns 对象列表
 */
export async function QxDepartmentTypeEx_GetObjExLstByPagerAsync(
