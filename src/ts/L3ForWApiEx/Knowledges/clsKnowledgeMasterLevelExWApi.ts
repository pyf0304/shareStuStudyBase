...
import {
  KnowledgeMasterLevel_GetObjLstCache,
  KnowledgeMasterLevel_GetObjLstAsync,
  KnowledgeMasterLevel_SortFunByKey,
...
export const knowledgeMasterLevelExController = 'KnowledgeMasterLevelExApi';
...
export async function KnowledgeMasterLevelEx_GetObjExLstByPagerAsync(
  ...
  if (
    ...
    for (const objInFor of arrKnowledgeMasterLevelExObjLst) {
      await KnowledgeMasterLevelEx_FuncMapByFldName(objSortInfo.SortFld, objInFor);
    }
  }
