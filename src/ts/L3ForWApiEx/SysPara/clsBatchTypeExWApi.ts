...
import {
  BatchType_GetObjLstCache,
  BatchType_GetObjLstByPagerAsync,
  BatchType_SortFunByKey,
} from '@/ts/L3ForWApi/SysPara/clsBatchTypeWApi';
 ...
 * @returns 对象列表
 */
export async function BatchTypeEx_GetObjExLstByPagerAsync(
  objPagerPara: stuPagerPara,
): Promise<Array<clsBatchTypeENEx>> {
