...
export class  clscc_CourseSchoolRelationEN extends clsGeneralTab
{
...
break;
default:
strMsg = `字段名:[${strFldName}]在表对象:[cc_CourseSchoolRelation]中不存在!(in ${this.constructor.name}.${strThisFuncName})`;
console.error(strMsg);
break;
}
}
...
//return propName in new clscc_CourseSchoolRelationEN();
const instance = new clscc_CourseSchoolRelationEN();
