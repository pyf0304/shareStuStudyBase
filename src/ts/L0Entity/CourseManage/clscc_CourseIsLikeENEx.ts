...
export class  clscc_CourseIsLikeENEx extends clscc_CourseIsLikeEN
{
//以下是属性变量
...
//return propName in new clscc_CourseIsLikeENEx();
const instance = new clscc_CourseIsLikeENEx();
