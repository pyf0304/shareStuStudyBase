 ...
 /**
 * 类名:clscc_CourseStudentRelationENEx
 * 表名:cc_CourseStudentRelation(01120150)
 * 版本:2025.06.10.1(服务器:WIN-SRV103-116)
 * 日期:2025/06/10 21:30:28
 * 生成者:pyf
 工程名称:问卷调查(0112)
...
export class  clscc_CourseStudentRelationENEx extends clscc_CourseStudentRelationEN
{
//以下是属性变量
...
//return propName in new clscc_CourseStudentRelationENEx();
const instance = new clscc_CourseStudentRelationENEx();
