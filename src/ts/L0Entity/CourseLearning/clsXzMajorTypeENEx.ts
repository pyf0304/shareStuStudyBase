...
export class  clsXzMajorTypeENEx extends clsXzMajorTypeEN
{
//以下是属性变量
...
//return propName in new clsXzMajorTypeENEx();
const instance = new clsXzMajorTypeENEx();
