 ...
 /**
 * 类名:clsClsRmTeachingCaseENEx
 * 表名:ClsRmTeachingCase(01120381)
 * 版本:2025.05.26.1(服务器:WIN-SRV103-116)
 * 日期:2025/06/08 09:48:26
 * 生成者:pyf
 工程名称:问卷调查(0112)
...
export class  clsClsRmTeachingCaseENEx extends clsClsRmTeachingCaseEN
{
//以下是属性变量
...
//return propName in new clsClsRmTeachingCaseENEx();
const instance = new clsClsRmTeachingCaseENEx();
