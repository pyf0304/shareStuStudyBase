 ...
 /**
 * 类名:clsvCurrEduClsTeacherENEx
 * 表名:vCurrEduClsTeacher(01120128)
 * 版本:2024.12.07.1(服务器:WIN-SRV103-116)
 * 日期:2024/12/20 16:02:50
 * 生成者:pyf
 工程名称:问卷调查(0112)
...
export class  clsvCurrEduClsTeacherENEx extends clsvCurrEduClsTeacherEN
{
//以下是属性变量
...
//return propName in new clsvCurrEduClsTeacherENEx();
const instance = new clsvCurrEduClsTeacherENEx();
