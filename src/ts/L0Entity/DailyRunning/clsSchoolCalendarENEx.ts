...
export class  clsSchoolCalendarENEx extends clsSchoolCalendarEN
{
//以下是属性变量
...
//return propName in new clsSchoolCalendarENEx();
const instance = new clsSchoolCalendarENEx();
