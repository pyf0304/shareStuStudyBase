...
export class  clsvgs_TeachingDateENEx extends clsvgs_TeachingDateEN
{
//以下是属性变量
...
//return propName in new clsvgs_TeachingDateENEx();
const instance = new clsvgs_TeachingDateENEx();
