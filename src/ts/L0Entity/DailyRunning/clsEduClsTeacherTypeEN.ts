 ...
 /**
 * 类名:clsEduClsTeacherTypeEN
 * 表名:EduClsTeacherType(01120133)
 * 版本:2025.06.10.1(服务器:WIN-SRV103-116)
 * 日期:2025/06/10 21:28:48
 * 生成者:pyf
 工程名称:问卷调查(0112)
...
export class  clsEduClsTeacherTypeEN extends clsGeneralTab
{
...
*/
private mstrIdEduClsTeacherType = "";    //教学班老师角色(主讲,辅导)流水号
...
*/
 public SetIdEduClsTeacherType (value: string)
{
if (value  != undefined)
{
 this.idEduClsTeacherType = value;
    this.hmProperty["idEduClsTeacherType"] = true;
...
{
case clsEduClsTeacherTypeEN.con_IdEduClsTeacherType:
this.idEduClsTeacherType = strValue;
    this.hmProperty["idEduClsTeacherType"] = true;
break;
case clsEduClsTeacherTypeEN.con_EduClsTeacherTypeId:
...
break;
default:
strMsg = `字段名:[${strFldName}]在表对象:[EduClsTeacherType]中不存在!(in ${this.constructor.name}.${strThisFuncName})`;
console.error(strMsg);
break;
}
}
...
//return propName in new clsEduClsTeacherTypeEN();
const instance = new clsEduClsTeacherTypeEN();
