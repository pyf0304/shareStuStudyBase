...
export class  clsvCurrEduClsStuENEx extends clsvCurrEduClsStuEN
{
//以下是属性变量
...
//return propName in new clsvCurrEduClsStuENEx();
const instance = new clsvCurrEduClsStuENEx();
