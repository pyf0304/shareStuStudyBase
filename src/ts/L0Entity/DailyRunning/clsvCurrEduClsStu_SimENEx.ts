...
export class  clsvCurrEduClsStu_SimENEx extends clsvCurrEduClsStu_SimEN
{
//以下是属性变量
...
//return propName in new clsvCurrEduClsStu_SimENEx();
const instance = new clsvCurrEduClsStu_SimENEx();
