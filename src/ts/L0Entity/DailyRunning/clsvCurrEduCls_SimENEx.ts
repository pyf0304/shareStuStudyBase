...
export class  clsvCurrEduCls_SimENEx extends clsvCurrEduCls_SimEN
{
//以下是属性变量
...
//return propName in new clsvCurrEduCls_SimENEx();
const instance = new clsvCurrEduCls_SimENEx();
