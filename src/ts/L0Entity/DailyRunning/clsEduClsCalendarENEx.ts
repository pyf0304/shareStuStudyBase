...
export class  clsEduClsCalendarENEx extends clsEduClsCalendarEN
{
//以下是属性变量
...
//return propName in new clsEduClsCalendarENEx();
const instance = new clsEduClsCalendarENEx();
