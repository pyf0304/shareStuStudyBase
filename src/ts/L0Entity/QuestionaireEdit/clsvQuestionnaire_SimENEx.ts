...
export class  clsvQuestionnaire_SimENEx extends clsvQuestionnaire_SimEN
{
//以下是属性变量
...
//return propName in new clsvQuestionnaire_SimENEx();
const instance = new clsvQuestionnaire_SimENEx();
