...
export class  clsvQuestionnaireENEx extends clsvQuestionnaireEN
{
//以下是属性变量
...
//return propName in new clsvQuestionnaireENEx();
const instance = new clsvQuestionnaireENEx();
