 ...
 /**
 * 类名:clsXzAdminClsTypeENEx
 * 表名:XzAdminClsType(01120195)
 * 版本:2025.05.26.1(服务器:WIN-SRV103-116)
 * 日期:2025/06/02 10:36:02
 * 生成者:pyf
 工程名称:问卷调查(0112)
...
export class  clsXzAdminClsTypeENEx extends clsXzAdminClsTypeEN
{
//以下是属性变量
...
//return propName in new clsXzAdminClsTypeENEx();
const instance = new clsXzAdminClsTypeENEx();
