...
export class  clsXzAdminClsENEx extends clsXzAdminClsEN
{
//以下是属性变量
...
//return propName in new clsXzAdminClsENEx();
const instance = new clsXzAdminClsENEx();
