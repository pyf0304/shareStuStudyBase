...
export class  clsvMessagePushUsersRelationENEx extends clsvMessagePushUsersRelationEN
{
//以下是属性变量
...
//return propName in new clsvMessagePushUsersRelationENEx();
const instance = new clsvMessagePushUsersRelationENEx();
