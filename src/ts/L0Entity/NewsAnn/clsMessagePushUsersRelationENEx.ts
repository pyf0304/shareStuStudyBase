 ...
 /**
 * 类名:clsMessagePushUsersRelationENEx
...
export class  clsMessagePushUsersRelationENEx extends clsMessagePushUsersRelationEN
{
//以下是属性变量
...
//return propName in new clsMessagePushUsersRelationENEx();
const instance = new clsMessagePushUsersRelationENEx();
