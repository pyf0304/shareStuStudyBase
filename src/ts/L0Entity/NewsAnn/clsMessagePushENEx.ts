...
export class  clsMessagePushENEx extends clsMessagePushEN
{
//以下是属性变量
...
//return propName in new clsMessagePushENEx();
const instance = new clsMessagePushENEx();
