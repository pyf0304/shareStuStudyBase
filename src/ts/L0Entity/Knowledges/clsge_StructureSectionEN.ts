...
export class  clsge_StructureSectionEN extends clsGeneralTab
{
...
private mstrStructureSectionName = "";    //结构章节名称
private mstrStructureSectionContent = "";    //结构章节内容
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
*/
 public SetStructureSectionName (value: string)
{
if (value  != undefined)
{
 this.structureSectionName = value;
    this.hmProperty["structureSectionName"] = true;
   this.sfUpdFldSetStr = this.updFldString;
}
}
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
*/
 public SetStructureSectionContent (value: string)
{
if (value  != undefined)
{
 this.structureSectionContent = value;
    this.hmProperty["structureSectionContent"] = true;
   this.sfUpdFldSetStr = this.updFldString;
}
}
...
break;
case clsge_StructureSectionEN.con_StructureSectionName:
this.structureSectionName = strValue;
    this.hmProperty["structureSectionName"] = true;
break;
case clsge_StructureSectionEN.con_StructureSectionContent:
this.structureSectionContent = strValue;
    this.hmProperty["structureSectionContent"] = true;
break;
case clsge_StructureSectionEN.con_CourseId:
...
//return propName in new clsge_StructureSectionEN();
const instance = new clsge_StructureSectionEN();
