...
export class  clsKnowledgeTypeENEx extends clsKnowledgeTypeEN
{
//以下是属性变量
...
//return propName in new clsKnowledgeTypeENEx();
const instance = new clsKnowledgeTypeENEx();
