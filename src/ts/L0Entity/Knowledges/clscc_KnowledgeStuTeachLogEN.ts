...
export class  clscc_KnowledgeStuTeachLogEN extends clsGeneralTab
{
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
*/
 public SetTeachingLog (value: string)
{
if (value  != undefined)
{
 this.teachingLog = value;
    this.hmProperty["teachingLog"] = true;
   this.sfUpdFldSetStr = this.updFldString;
}
}
...
//return propName in new clscc_KnowledgeStuTeachLogEN();
const instance = new clscc_KnowledgeStuTeachLogEN();
