 ...
 /**
 * 类名:clsgs_KnowledgesLogic_UserENEx
...
export class  clsgs_KnowledgesLogic_UserENEx extends clsgs_KnowledgesLogic_UserEN
{
//以下是属性变量
...
//return propName in new clsgs_KnowledgesLogic_UserENEx();
const instance = new clsgs_KnowledgesLogic_UserENEx();
