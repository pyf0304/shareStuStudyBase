 ...
 /**
 * 类名:clsKnowledgeMasterLevelENEx
 * 表名:KnowledgeMasterLevel(01120891)
 * 版本:2025.06.10.1(服务器:WIN-SRV103-116)
 * 日期:2025/06/10 21:35:48
 * 生成者:pyf
 工程名称:问卷调查(0112)
...
export class  clsKnowledgeMasterLevelENEx extends clsKnowledgeMasterLevelEN
{
//以下是属性变量
...
//return propName in new clsKnowledgeMasterLevelENEx();
const instance = new clsKnowledgeMasterLevelENEx();
