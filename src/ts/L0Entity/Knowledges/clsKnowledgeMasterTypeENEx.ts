...
export class  clsKnowledgeMasterTypeENEx extends clsKnowledgeMasterTypeEN
{
//以下是属性变量
...
//return propName in new clsKnowledgeMasterTypeENEx();
const instance = new clsKnowledgeMasterTypeENEx();
