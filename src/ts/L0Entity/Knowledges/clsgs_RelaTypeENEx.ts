 ...
 /**
 * 类名:clsgs_RelaTypeENEx
 * 表名:gs_RelaType(01120871)
 * 版本:2025.06.10.1(服务器:WIN-SRV103-116)
 * 日期:2025/06/10 21:35:11
 * 生成者:pyf
 工程名称:问卷调查(0112)
...
export class  clsgs_RelaTypeENEx extends clsgs_RelaTypeEN
{
//以下是属性变量
...
//return propName in new clsgs_RelaTypeENEx();
const instance = new clsgs_RelaTypeENEx();
