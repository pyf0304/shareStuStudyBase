...
export class  clsKnowledgeTypeEN extends clsGeneralTab
{
...
private mstrKnowledgeTypeName = "";    //知识点类型名
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
*/
 public SetKnowledgeTypeName (value: string)
{
if (value  != undefined)
{
...
//return propName in new clsKnowledgeTypeEN();
const instance = new clsKnowledgeTypeEN();
