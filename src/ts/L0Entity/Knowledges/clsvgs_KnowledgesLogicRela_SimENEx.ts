 ...
 /**
 * 类名:clsvgs_KnowledgesLogicRela_SimENEx
...
export class  clsvgs_KnowledgesLogicRela_SimENEx extends clsvgs_KnowledgesLogicRela_SimEN
{
//以下是属性变量
...
//return propName in new clsvgs_KnowledgesLogicRela_SimENEx();
const instance = new clsvgs_KnowledgesLogicRela_SimENEx();
