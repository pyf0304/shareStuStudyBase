 ...
 /**
 * 类名:clsvgs_KnowledgesLogic_SimENEx
...
export class  clsvgs_KnowledgesLogic_SimENEx extends clsvgs_KnowledgesLogic_SimEN
{
//以下是属性变量
...
//return propName in new clsvgs_KnowledgesLogic_SimENEx();
const instance = new clsvgs_KnowledgesLogic_SimENEx();
