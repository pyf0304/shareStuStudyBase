 ...
 /**
 * 类名:clsvcc_KnowledgesExamLibRelaENEx
...
export class  clsvcc_KnowledgesExamLibRelaENEx extends clsvcc_KnowledgesExamLibRelaEN
{
//以下是属性变量
...
//return propName in new clsvcc_KnowledgesExamLibRelaENEx();
const instance = new clsvcc_KnowledgesExamLibRelaENEx();
