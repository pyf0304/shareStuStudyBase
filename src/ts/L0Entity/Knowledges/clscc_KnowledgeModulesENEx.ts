...
export class  clscc_KnowledgeModulesENEx extends clscc_KnowledgeModulesEN
{
//以下是属性变量
...
//return propName in new clscc_KnowledgeModulesENEx();
const instance = new clscc_KnowledgeModulesENEx();
