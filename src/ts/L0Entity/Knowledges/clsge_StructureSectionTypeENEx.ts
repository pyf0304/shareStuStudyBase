 ...
 /**
 * 类名:clsge_StructureSectionTypeENEx
 * 表名:ge_StructureSectionType(01120901)
 * 版本:2025.06.10.1(服务器:WIN-SRV103-116)
 * 日期:2025/06/10 21:35:24
 * 生成者:pyf
 工程名称:问卷调查(0112)
...
export class  clsge_StructureSectionTypeENEx extends clsge_StructureSectionTypeEN
{
//以下是属性变量
...
//return propName in new clsge_StructureSectionTypeENEx();
const instance = new clsge_StructureSectionTypeENEx();
