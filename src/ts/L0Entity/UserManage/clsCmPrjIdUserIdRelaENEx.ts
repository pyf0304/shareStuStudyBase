...
export class  clsCmPrjIdUserIdRelaENEx extends clsCmPrjIdUserIdRelaEN
{
//以下是属性变量
...
//return propName in new clsCmPrjIdUserIdRelaENEx();
const instance = new clsCmPrjIdUserIdRelaENEx();
