...
export class  clsUsers_JTEN extends clsGeneralTab
{
...
private mstrSiteName = "";    //工地名称
private mstrJobCategoryId = "";    //岗位类别Id
private mstrManagedDepartmentId = "";    //管理的部门Id
private mstrIDNumber = "";    //身份证号
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
*/
 public SetSiteName (value: string)
{
if (value  != undefined)
{
 this.siteName = value;
    this.hmProperty["siteName"] = true;
   this.sfUpdFldSetStr = this.updFldString;
}
}
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
*/
 public SetJobCategoryId (value: string)
{
if (value  != undefined)
{
 this.jobCategoryId = value;
    this.hmProperty["jobCategoryId"] = true;
   this.sfUpdFldSetStr = this.updFldString;
}
}
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
*/
 public SetManagedDepartmentId (value: string)
{
if (value  != undefined)
{
 this.managedDepartmentId = value;
    this.hmProperty["managedDepartmentId"] = true;
   this.sfUpdFldSetStr = this.updFldString;
}
}
...
break;
case clsUsers_JTEN.con_SiteName:
this.siteName = strValue;
    this.hmProperty["siteName"] = true;
break;
case clsUsers_JTEN.con_JobCategoryId:
this.jobCategoryId = strValue;
    this.hmProperty["jobCategoryId"] = true;
break;
case clsUsers_JTEN.con_ManagedDepartmentId:
this.managedDepartmentId = strValue;
    this.hmProperty["managedDepartmentId"] = true;
break;
case clsUsers_JTEN.con_IDNumber:
this.iDNumber = strValue;
    this.hmProperty["iDNumber"] = true;
break;
case clsUsers_JTEN.con_UpdDate:
...
break;
default:
strMsg = `字段名:[${strFldName}]在表对象:[Users_JT]中不存在!(in ${this.constructor.name}.${strThisFuncName})`;
console.error(strMsg);
break;
}
}
...
//return propName in new clsUsers_JTEN();
const instance = new clsUsers_JTEN();
