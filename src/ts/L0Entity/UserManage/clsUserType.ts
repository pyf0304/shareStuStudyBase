...
switch (strFldName)
{
case clsUserType.con_UserTypeId:
return this.userTypeId;
case clsUserType.con_UserTypeName:
return this.userTypeName;
case clsUserType.con_UserTypeNameSim:
return this.userTypeNameSim;
case clsUserType.con_UserTypeENName:
return this.userTypeENName;
case clsUserType.con_Memo:
return this.memo;
default:
