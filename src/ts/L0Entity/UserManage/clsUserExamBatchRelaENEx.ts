...
export class  clsUserExamBatchRelaENEx extends clsUserExamBatchRelaEN
{
//以下是属性变量
...
//return propName in new clsUserExamBatchRelaENEx();
const instance = new clsUserExamBatchRelaENEx();
