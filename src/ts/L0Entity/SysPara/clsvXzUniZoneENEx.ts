...
export class  clsvXzUniZoneENEx extends clsvXzUniZoneEN
{
//以下是属性变量
...
//return propName in new clsvXzUniZoneENEx();
const instance = new clsvXzUniZoneENEx();
