 ...
 /**
 * 类名:clsTeachingMethodsENEx
 * 表名:TeachingMethods(01120966)
 * 版本:2025.05.26.1(服务器:WIN-SRV103-116)
 * 日期:2025/06/02 10:35:35
 * 生成者:pyf
 工程名称:问卷调查(0112)
...
export class  clsTeachingMethodsENEx extends clsTeachingMethodsEN
{
//以下是属性变量
...
//return propName in new clsTeachingMethodsENEx();
const instance = new clsTeachingMethodsENEx();
