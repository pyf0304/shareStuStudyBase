...
export class  clsSchoolTypeENEx extends clsSchoolTypeEN
{
//以下是属性变量
...
//return propName in new clsSchoolTypeENEx();
const instance = new clsSchoolTypeENEx();
