...
export class  clsSchoolYearENEx extends clsSchoolYearEN
{
//以下是属性变量
...
//return propName in new clsSchoolYearENEx();
const instance = new clsSchoolYearENEx();
