 ...
 /**
 * 类名:clsAssessmentMethodsENEx
 * 表名:AssessmentMethods(01120967)
 * 版本:2025.05.26.1(服务器:WIN-SRV103-116)
 * 日期:2025/06/02 10:33:53
 * 生成者:pyf
 工程名称:问卷调查(0112)
...
export class  clsAssessmentMethodsENEx extends clsAssessmentMethodsEN
{
//以下是属性变量
...
//return propName in new clsAssessmentMethodsENEx();
const instance = new clsAssessmentMethodsENEx();
