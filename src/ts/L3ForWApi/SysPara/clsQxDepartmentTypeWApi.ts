 ...
 * @returns 对象列表子集
*/
export  async function QxDepartmentType_GetSubObjLstCache(objQxDepartmentTypeCond: ConditionCollection ) {
const strThisFuncName = "GetSubObjLstCache";
const arrQxDepartmentTypeObjLstCache = await QxDepartmentType_GetObjLstCache();
let arrQxDepartmentTypeSel = arrQxDepartmentTypeObjLstCache;
if (objQxDepartmentTypeCond.GetConditions().length == 0) return arrQxDepartmentTypeSel;
try {
//console.log(sstrKeys);
for (const objCondition of objQxDepartmentTypeCond.GetConditions()) {
...
let arrQxDepartmentTypeSel = arrQxDepartmentTypeObjLstCache;
const objQxDepartmentTypeCond = objPagerPara.conditionCollection;
if (objQxDepartmentTypeCond == null)
{
 ...
 * @returns 对象列表子集
*/
export  async function QxDepartmentType_IsExistRecordCache(objQxDepartmentTypeCond: ConditionCollection) {
const strThisFuncName = "IsExistRecordCache";
const arrQxDepartmentTypeObjLstCache = await QxDepartmentType_GetObjLstCache();
if (arrQxDepartmentTypeObjLstCache == null) return false;
let arrQxDepartmentTypeSel = arrQxDepartmentTypeObjLstCache;
if (objQxDepartmentTypeCond.GetConditions().length == 0) return arrQxDepartmentTypeSel.length>0?true:false;
try {
for (const objCondition of objQxDepartmentTypeCond.GetConditions()) {
if (objCondition == null) continue; 
const strKey = objCondition.fldName;
 ...
 * @returns 对象列表记录数
*/
export  async function QxDepartmentType_GetRecCountByCondCache(objQxDepartmentTypeCond: ConditionCollection ) {
const strThisFuncName = "GetRecCountByCondCache";
const arrQxDepartmentTypeObjLstCache = await QxDepartmentType_GetObjLstCache();
if (arrQxDepartmentTypeObjLstCache == null) return 0;
let arrQxDepartmentTypeSel = arrQxDepartmentTypeObjLstCache;
if (objQxDepartmentTypeCond.GetConditions().length == 0) return arrQxDepartmentTypeSel.length;
try {
for (const objCondition of objQxDepartmentTypeCond.GetConditions()) {
if (objCondition == null) continue; 
const strKey = objCondition.fldName;
