...
const strUrl = GetWebApiUrl_GP(qxDepartmentInfo_Controller, strAction);
...
if (IsNullOrEmpty(strDepartmentId) == true)
{
  const strMsg = Format("参数:[strDepartmentId]不能为空!(In clsQxDepartmentInfoWApi.GetObjByDepartmentIdlocalStorage)");
console.error(strMsg);
 throw (strMsg);
}
 ...
 * @returns 对象
*/
export  async function QxDepartmentInfo_GetObjByDepartmentIdCache(strDepartmentId: string, bolTryAsyncOnce = true) {
const strThisFuncName = "GetObjByDepartmentIdCache";

if (IsNullOrEmpty(strDepartmentId) == true)
{
  const strMsg = Format("参数:[strDepartmentId]不能为空!(In clsQxDepartmentInfoWApi.GetObjByDepartmentIdCache)");
console.error(strMsg);
 throw (strMsg);
}
...
try
{
const arrQxDepartmentInfoSel = arrQxDepartmentInfoObjLstCache.filter(x => 
...
{
const objQxDepartmentInfoConst = await QxDepartmentInfo_GetObjByDepartmentIdAsync(strDepartmentId);
...
{
const arrQxDepartmentInfoObjLstCache = await QxDepartmentInfo_GetObjLstCache();
const obj = arrQxDepartmentInfoObjLstCache.find(x => 
 ...
 * @returns 返回两个对象比较的结果
*/
export  function QxDepartmentInfo_SortFunDefa(a:clsQxDepartmentInfoEN , b:clsQxDepartmentInfoEN): number 
{
 ...
 * @returns 返回两个对象比较的结果
*/
export  function QxDepartmentInfo_SortFunDefa2Fld(a:clsQxDepartmentInfoEN , b:clsQxDepartmentInfoEN): number 
{
...
if (IsNullOrEmpty(strDepartmentId) == true)
{
  const strMsg = Format("参数:[strDepartmentId]不能为空!(In clsQxDepartmentInfoWApi.GetNameByDepartmentIdCache)");
console.error(strMsg);
 throw (strMsg);
}
const arrQxDepartmentInfoObjLstCache = await QxDepartmentInfo_GetObjLstCache();
...
arrQxDepartmentInfoSel = arrQxDepartmentInfoSel.filter(x => x.GetFldValue(strInFldName).toString() == strInValue.toString());
break;
case enumComparisonOp.Like_03:
arrQxDepartmentInfoSel = arrQxDepartmentInfoSel.filter(x => x.GetFldValue(strInFldName).toString().indexOf(strInValue.toString()) != -1);
break;
case enumComparisonOp.In_04:
arrValues = strInValue.split(',');
arrQxDepartmentInfoSel = arrQxDepartmentInfoSel.filter(x => arrValues.indexOf(x.GetFldValue(strInFldName).toString()) != -1);
break;
}
break;
case "boolean":
...
{
arrQxDepartmentInfoSel = arrQxDepartmentInfoSel.filter(x => x.GetFldValue(strInFldName) == strInValue);
}
break;
case "number":
 ...
 **/
export  async function QxDepartmentInfo_GetFldValueAsync(strFldName: string, strWhereCond: string): Promise<Array<string>>  
{
...
const arrQxDepartmentInfoObjLstT = QxDepartmentInfo_GetObjLstByJSONObjLst(arrQxDepartmentInfoExObjLstCache);
...
const arrQxDepartmentInfoExObjLstCache: Array<clsQxDepartmentInfoEN> = JSON.parse(strTempObjLst);
const arrQxDepartmentInfoObjLstT = QxDepartmentInfo_GetObjLstByJSONObjLst(arrQxDepartmentInfoExObjLstCache);
return arrQxDepartmentInfoObjLstT;
}
try
 ...
 * @returns 对象列表子集
*/
export  async function QxDepartmentInfo_GetSubObjLstCache(objQxDepartmentInfoCond: ConditionCollection ) {
const strThisFuncName = "GetSubObjLstCache";
const arrQxDepartmentInfoObjLstCache = await QxDepartmentInfo_GetObjLstCache();
let arrQxDepartmentInfoSel = arrQxDepartmentInfoObjLstCache;
if (objQxDepartmentInfoCond.GetConditions().length == 0) return arrQxDepartmentInfoSel;
try {
//console.log(sstrKeys);
for (const objCondition of objQxDepartmentInfoCond.GetConditions()) {
...
if (strComparisonOp == "=") {
arrQxDepartmentInfoSel = arrQxDepartmentInfoSel.filter(x => x.GetFldValue(strKey).toString() == strValue.toString());
}
else if (strComparisonOp == "like") {
arrQxDepartmentInfoSel = arrQxDepartmentInfoSel.filter(x => x.GetFldValue(strKey).toString().indexOf(strValue.toString()) != -1);
}
else if (strComparisonOp == "length greater") {
arrQxDepartmentInfoSel = arrQxDepartmentInfoSel.filter(x => x.GetFldValue(strKey).toString().length > Number(strValue.toString()));
}
...
if (strValue == null) continue;
if (strComparisonOp == "=") {
arrQxDepartmentInfoSel = arrQxDepartmentInfoSel.filter(x => x.GetFldValue(strKey) == strValue);
}
break;
case "number":
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]缓存对象列表中获取子集对象不成功!(in {2}.{3})", e, JSON.stringify( objQxDepartmentInfoCond), qxDepartmentInfo_ConstructorName, strThisFuncName);
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 对象列表
*/
export  async function QxDepartmentInfo_GetObjLstByDepartmentIdLstCache(arrDepartmentIdLst: Array<string> ) {
const strThisFuncName = "GetObjLstByDepartmentIdLstCache";
try
{
const arrQxDepartmentInfoObjLstCache = await QxDepartmentInfo_GetObjLstCache();
const arrQxDepartmentInfoSel = arrQxDepartmentInfoObjLstCache.filter(x => arrDepartmentIdLst.indexOf(x.departmentId)>-1);
return arrQxDepartmentInfoSel;
}
catch (e)
{
...
let arrQxDepartmentInfoSel = arrQxDepartmentInfoObjLstCache;
const objQxDepartmentInfoCond = objPagerPara.conditionCollection;
if (objQxDepartmentInfoCond == null)
{
...
arrQxDepartmentInfoSel = arrQxDepartmentInfoSel.filter(x => arrValues.indexOf(x.GetFldValue(strKey).toString()) != -1);
}
break;
case "boolean":
if (strValue == null) continue;
...
arrQxDepartmentInfoSel = arrQxDepartmentInfoSel.sort(QxDepartmentInfo_SortFunByKey(strSortFld, strSortType));
}
else {
...
let strUrl = GetWebApiUrl_GP(qxDepartmentInfo_Controller, strAction);
...
{
const strMsg = `检查数据不成功,${e}.(in ${ qxDepartmentInfo_ConstructorName }.${strThisFuncName})`;
console.error(strMsg);
alert(strMsg);
...
return { keyword: objQxDepartmentInfoEN.departmentId, success: returnBool };//一定要有一个返回值,否则会出错!
}
catch(e)
{
const strMsg = `添加记录不成功,${e}.(in ${ qxDepartmentInfo_ConstructorName }.${ strThisFuncName })`;
console.error(strMsg);
throw(strMsg);
}
}
 ...
 **/
export  async function QxDepartmentInfo_UpdateObjSave(objQxDepartmentInfoEN: clsQxDepartmentInfoEN): Promise<boolean>{
...
{
const strMsg = `修改记录不成功,${e}.(in ${ qxDepartmentInfo_ConstructorName }.${ strThisFuncName })`;
console.error(strMsg);
throw(strMsg);
}
}
 ...
 * @returns 获取修改是否成功？
 **/
export  async function QxDepartmentInfo_EditRecordExAsync(objQxDepartmentInfoEN: clsQxDepartmentInfoEN): Promise<boolean>  
{
...
let arrQxDepartmentInfoSel = arrQxDepartmentInfoObjLstCache;
if (objQxDepartmentInfoCond.GetConditions().length == 0) return arrQxDepartmentInfoSel.length>0?true:false;
try {
for (const objCondition of objQxDepartmentInfoCond.GetConditions()) {
if (objCondition == null) continue; 
const strKey = objCondition.fldName;
...
const strMsg = Format("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify( objQxDepartmentInfoCond), qxDepartmentInfo_ConstructorName, strThisFuncName);
console.error(strMsg);
throw new Error(strMsg);
}
return false;
...
try
{
const arrQxDepartmentInfoSel = arrQxDepartmentInfoObjLstCache.filter(x => x.departmentId == strDepartmentId);
if (arrQxDepartmentInfoSel.length > 0)
{
return true;
}
 ...
 * @returns 对象列表记录数
*/
export  async function QxDepartmentInfo_GetRecCountByCondCache(objQxDepartmentInfoCond: ConditionCollection ) {
const strThisFuncName = "GetRecCountByCondCache";
const arrQxDepartmentInfoObjLstCache = await QxDepartmentInfo_GetObjLstCache();
if (arrQxDepartmentInfoObjLstCache == null) return 0;
let arrQxDepartmentInfoSel = arrQxDepartmentInfoObjLstCache;
if (objQxDepartmentInfoCond.GetConditions().length == 0) return arrQxDepartmentInfoSel.length;
try {
for (const objCondition of objQxDepartmentInfoCond.GetConditions()) {
if (objCondition == null) continue; 
const strKey = objCondition.fldName;
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]从缓存对象列表中获取记录数不成功!(in {2}.{3})", e, JSON.stringify( objQxDepartmentInfoCond), qxDepartmentInfo_ConstructorName, strThisFuncName);
console.error(strMsg);
throw new Error(strMsg);
}
return 0;
...
clsQxDepartmentInfoEN._RefreshTimeLst.push(clsDateTime.getTodayDateTimeStr(0));
}
...
**/
export  function QxDepartmentInfo_GetLastRefreshTime():string
{
if (clsQxDepartmentInfoEN._RefreshTimeLst.length == 0) return "";
return clsQxDepartmentInfoEN._RefreshTimeLst[clsQxDepartmentInfoEN._RefreshTimeLst.length - 1];
}
...
*/
export  async function QxDepartmentInfo_BindDdl_DepartmentIdInDivCache(objDiv: HTMLDivElement, strDdlName: string )
{
...
BindDdl_ObjLstInDivObj(objDiv, strDdlName, arrObjLstSel, clsQxDepartmentInfoEN.con_DepartmentId, clsQxDepartmentInfoEN.con_DepartmentName, "部门...");
}
...
*/
export  async function QxDepartmentInfo_GetArrQxDepartmentInfo()
{

//为数据源于表的下拉框设置内容
//console.log("开始：BindDdl_DepartmentIdInDivCache");
const arrQxDepartmentInfo = new Array<clsQxDepartmentInfoEN>();
const arrObjLstSel = await QxDepartmentInfo_GetObjLstCache();
if (arrObjLstSel == null) return null;
const obj0 = new clsQxDepartmentInfoEN();
obj0.departmentId = '0';
obj0.departmentName = '选部门...';
arrQxDepartmentInfo.push(obj0);
arrObjLstSel.forEach(x => arrQxDepartmentInfo.push(x));
return arrQxDepartmentInfo;
}
...
{
 throw new Error(`(errid:Watl000411)字段[部门名]不能为空(In 部门)!(clsQxDepartmentInfoBL:CheckPropertyNew0)`);
}
//检查字段长度, 若字符型字段长度超出规定的长度,即非法!
if (IsNullOrEmpty(pobjQxDepartmentInfoEN.departmentId) == false && GetStrLen(pobjQxDepartmentInfoEN.departmentId) > 8)
{
 throw new Error(`(errid:Watl000413)字段[部门Id(departmentId)]的长度不能超过8(In 部门(QxDepartmentInfo))!值:${pobjQxDepartmentInfoEN.departmentId}(clsQxDepartmentInfoBL:CheckPropertyNew)`);
}
if (IsNullOrEmpty(pobjQxDepartmentInfoEN.departmentName) == false && GetStrLen(pobjQxDepartmentInfoEN.departmentName) > 100)
{
 throw new Error(`(errid:Watl000413)字段[部门名(departmentName)]的长度不能超过100(In 部门(QxDepartmentInfo))!值:${pobjQxDepartmentInfoEN.departmentName}(clsQxDepartmentInfoBL:CheckPropertyNew)`);
}
if (IsNullOrEmpty(pobjQxDepartmentInfoEN.departmentAbbrName) == false && GetStrLen(pobjQxDepartmentInfoEN.departmentAbbrName) > 8)
{
 throw new Error(`(errid:Watl000413)字段[名称缩写(departmentAbbrName)]的长度不能超过8(In 部门(QxDepartmentInfo))!值:${pobjQxDepartmentInfoEN.departmentAbbrName}(clsQxDepartmentInfoBL:CheckPropertyNew)`);
}
if (IsNullOrEmpty(pobjQxDepartmentInfoEN.departmentTypeId) == false && GetStrLen(pobjQxDepartmentInfoEN.departmentTypeId) > 2)
{
 throw new Error(`(errid:Watl000413)字段[部门类型ID(departmentTypeId)]的长度不能超过2(In 部门(QxDepartmentInfo))!值:${pobjQxDepartmentInfoEN.departmentTypeId}(clsQxDepartmentInfoBL:CheckPropertyNew)`);
}
if (IsNullOrEmpty(pobjQxDepartmentInfoEN.upDepartmentId) == false && GetStrLen(pobjQxDepartmentInfoEN.upDepartmentId) > 6)
{
 throw new Error(`(errid:Watl000413)字段[所属部门号(upDepartmentId)]的长度不能超过6(In 部门(QxDepartmentInfo))!值:${pobjQxDepartmentInfoEN.upDepartmentId}(clsQxDepartmentInfoBL:CheckPropertyNew)`);
}
if (IsNullOrEmpty(pobjQxDepartmentInfoEN.memo) == false && GetStrLen(pobjQxDepartmentInfoEN.memo) > 1000)
{
 throw new Error(`(errid:Watl000413)字段[备注(memo)]的长度不能超过1000(In 部门(QxDepartmentInfo))!值:${pobjQxDepartmentInfoEN.memo}(clsQxDepartmentInfoBL:CheckPropertyNew)`);
}
//检查字段的数据类型是否正确
...
{
 throw new Error(`(errid:Watl000414)字段[部门Id(departmentId)]的值:[${pobjQxDepartmentInfoEN.departmentId}], 非法,应该为字符型(In 部门(QxDepartmentInfo))!(clsQxDepartmentInfoBL:CheckPropertyNew0)`);
}
...
{
 throw new Error(`(errid:Watl000414)字段[部门名(departmentName)]的值:[${pobjQxDepartmentInfoEN.departmentName}], 非法,应该为字符型(In 部门(QxDepartmentInfo))!(clsQxDepartmentInfoBL:CheckPropertyNew0)`);
}
...
{
 throw new Error(`(errid:Watl000414)字段[名称缩写(departmentAbbrName)]的值:[${pobjQxDepartmentInfoEN.departmentAbbrName}], 非法,应该为字符型(In 部门(QxDepartmentInfo))!(clsQxDepartmentInfoBL:CheckPropertyNew0)`);
}
...
{
 throw new Error(`(errid:Watl000414)字段[部门类型ID(departmentTypeId)]的值:[${pobjQxDepartmentInfoEN.departmentTypeId}], 非法,应该为字符型(In 部门(QxDepartmentInfo))!(clsQxDepartmentInfoBL:CheckPropertyNew0)`);
}
...
{
 throw new Error(`(errid:Watl000414)字段[所属部门号(upDepartmentId)]的值:[${pobjQxDepartmentInfoEN.upDepartmentId}], 非法,应该为字符型(In 部门(QxDepartmentInfo))!(clsQxDepartmentInfoBL:CheckPropertyNew0)`);
}
...
{
 throw new Error(`(errid:Watl000414)字段[排序号(orderNum)]的值:[${pobjQxDepartmentInfoEN.orderNum}], 非法,应该为数值型(In 部门(QxDepartmentInfo))!(clsQxDepartmentInfoBL:CheckPropertyNew0)`);
}
...
{
 throw new Error(`(errid:Watl000414)字段[是否在用(inUse)]的值:[${pobjQxDepartmentInfoEN.inUse}], 非法,应该为布尔型(In 部门(QxDepartmentInfo))!(clsQxDepartmentInfoBL:CheckPropertyNew0)`);
}
...
{
 throw new Error(`(errid:Watl000414)字段[备注(memo)]的值:[${pobjQxDepartmentInfoEN.memo}], 非法,应该为字符型(In 部门(QxDepartmentInfo))!(clsQxDepartmentInfoBL:CheckPropertyNew0)`);
}
//检查外键, 作为外键应该和主键的字段长度是一样的, 若不一样,即非法!
if (IsNullOrEmpty(pobjQxDepartmentInfoEN.departmentTypeId) == false && pobjQxDepartmentInfoEN.departmentTypeId != '[nuull]' && GetStrLen(pobjQxDepartmentInfoEN.departmentTypeId) !=  2)
{
 throw ("(errid:Watl000415)字段[部门类型ID]作为外键字段,长度应该为2(In 部门)!(clsQxDepartmentInfoBL:CheckPropertyNew)");
}
...
if (IsNullOrEmpty(pobjQxDepartmentInfoEN.departmentId) == false && GetStrLen(pobjQxDepartmentInfoEN.departmentId) > 8)
{
 throw new Error(`(errid:Watl000416)字段[部门Id(departmentId)]的长度不能超过8(In 部门(QxDepartmentInfo))!值:${pobjQxDepartmentInfoEN.departmentId}(clsQxDepartmentInfoBL:CheckProperty4Update)`);
}
if (IsNullOrEmpty(pobjQxDepartmentInfoEN.departmentName) == false && GetStrLen(pobjQxDepartmentInfoEN.departmentName) > 100)
{
 throw new Error(`(errid:Watl000416)字段[部门名(departmentName)]的长度不能超过100(In 部门(QxDepartmentInfo))!值:${pobjQxDepartmentInfoEN.departmentName}(clsQxDepartmentInfoBL:CheckProperty4Update)`);
}
if (IsNullOrEmpty(pobjQxDepartmentInfoEN.departmentAbbrName) == false && GetStrLen(pobjQxDepartmentInfoEN.departmentAbbrName) > 8)
{
 throw new Error(`(errid:Watl000416)字段[名称缩写(departmentAbbrName)]的长度不能超过8(In 部门(QxDepartmentInfo))!值:${pobjQxDepartmentInfoEN.departmentAbbrName}(clsQxDepartmentInfoBL:CheckProperty4Update)`);
}
if (IsNullOrEmpty(pobjQxDepartmentInfoEN.departmentTypeId) == false && GetStrLen(pobjQxDepartmentInfoEN.departmentTypeId) > 2)
{
 throw new Error(`(errid:Watl000416)字段[部门类型ID(departmentTypeId)]的长度不能超过2(In 部门(QxDepartmentInfo))!值:${pobjQxDepartmentInfoEN.departmentTypeId}(clsQxDepartmentInfoBL:CheckProperty4Update)`);
}
if (IsNullOrEmpty(pobjQxDepartmentInfoEN.upDepartmentId) == false && GetStrLen(pobjQxDepartmentInfoEN.upDepartmentId) > 6)
{
 throw new Error(`(errid:Watl000416)字段[所属部门号(upDepartmentId)]的长度不能超过6(In 部门(QxDepartmentInfo))!值:${pobjQxDepartmentInfoEN.upDepartmentId}(clsQxDepartmentInfoBL:CheckProperty4Update)`);
}
if (IsNullOrEmpty(pobjQxDepartmentInfoEN.memo) == false && GetStrLen(pobjQxDepartmentInfoEN.memo) > 1000)
{
 throw new Error(`(errid:Watl000416)字段[备注(memo)]的长度不能超过1000(In 部门(QxDepartmentInfo))!值:${pobjQxDepartmentInfoEN.memo}(clsQxDepartmentInfoBL:CheckProperty4Update)`);
}
//检查字段的数据类型是否正确
if (IsNullOrEmpty(pobjQxDepartmentInfoEN.departmentId) == false && undefined !== pobjQxDepartmentInfoEN.departmentId && tzDataType.isString(pobjQxDepartmentInfoEN.departmentId) === false)
{
 throw new Error(`(errid:Watl000417)字段[部门Id(departmentId)]的值:[${pobjQxDepartmentInfoEN.departmentId}], 非法,应该为字符型(In 部门(QxDepartmentInfo))!(clsQxDepartmentInfoBL:CheckProperty4Update)`);
}
if (IsNullOrEmpty(pobjQxDepartmentInfoEN.departmentName) == false && undefined !== pobjQxDepartmentInfoEN.departmentName && tzDataType.isString(pobjQxDepartmentInfoEN.departmentName) === false)
{
 throw new Error(`(errid:Watl000417)字段[部门名(departmentName)]的值:[${pobjQxDepartmentInfoEN.departmentName}], 非法,应该为字符型(In 部门(QxDepartmentInfo))!(clsQxDepartmentInfoBL:CheckProperty4Update)`);
}
if (IsNullOrEmpty(pobjQxDepartmentInfoEN.departmentAbbrName) == false && undefined !== pobjQxDepartmentInfoEN.departmentAbbrName && tzDataType.isString(pobjQxDepartmentInfoEN.departmentAbbrName) === false)
{
 throw new Error(`(errid:Watl000417)字段[名称缩写(departmentAbbrName)]的值:[${pobjQxDepartmentInfoEN.departmentAbbrName}], 非法,应该为字符型(In 部门(QxDepartmentInfo))!(clsQxDepartmentInfoBL:CheckProperty4Update)`);
}
if (IsNullOrEmpty(pobjQxDepartmentInfoEN.departmentTypeId) == false && undefined !== pobjQxDepartmentInfoEN.departmentTypeId && tzDataType.isString(pobjQxDepartmentInfoEN.departmentTypeId) === false)
{
 throw new Error(`(errid:Watl000417)字段[部门类型ID(departmentTypeId)]的值:[${pobjQxDepartmentInfoEN.departmentTypeId}], 非法,应该为字符型(In 部门(QxDepartmentInfo))!(clsQxDepartmentInfoBL:CheckProperty4Update)`);
}
if (IsNullOrEmpty(pobjQxDepartmentInfoEN.upDepartmentId) == false && undefined !== pobjQxDepartmentInfoEN.upDepartmentId && tzDataType.isString(pobjQxDepartmentInfoEN.upDepartmentId) === false)
{
 throw new Error(`(errid:Watl000417)字段[所属部门号(upDepartmentId)]的值:[${pobjQxDepartmentInfoEN.upDepartmentId}], 非法,应该为字符型(In 部门(QxDepartmentInfo))!(clsQxDepartmentInfoBL:CheckProperty4Update)`);
}
if (null != pobjQxDepartmentInfoEN.orderNum && undefined !== pobjQxDepartmentInfoEN.orderNum && tzDataType.isNumber(pobjQxDepartmentInfoEN.orderNum) === false)
{
 throw new Error(`(errid:Watl000417)字段[排序号(orderNum)]的值:[${pobjQxDepartmentInfoEN.orderNum}], 非法,应该为数值型(In 部门(QxDepartmentInfo))!(clsQxDepartmentInfoBL:CheckProperty4Update)`);
}
if (null != pobjQxDepartmentInfoEN.inUse && undefined !== pobjQxDepartmentInfoEN.inUse && tzDataType.isBoolean(pobjQxDepartmentInfoEN.inUse) === false)
{
 throw new Error(`(errid:Watl000417)字段[是否在用(inUse)]的值:[${pobjQxDepartmentInfoEN.inUse}], 非法,应该为布尔型(In 部门(QxDepartmentInfo))!(clsQxDepartmentInfoBL:CheckProperty4Update)`);
}
if (IsNullOrEmpty(pobjQxDepartmentInfoEN.memo) == false && undefined !== pobjQxDepartmentInfoEN.memo && tzDataType.isString(pobjQxDepartmentInfoEN.memo) === false)
{
 throw new Error(`(errid:Watl000417)字段[备注(memo)]的值:[${pobjQxDepartmentInfoEN.memo}], 非法,应该为字符型(In 部门(QxDepartmentInfo))!(clsQxDepartmentInfoBL:CheckProperty4Update)`);
}
//检查主键是否为Null或者空!
...
if (IsNullOrEmpty(pobjQxDepartmentInfoEN.departmentTypeId) == false && pobjQxDepartmentInfoEN.departmentTypeId != '[nuull]' && GetStrLen(pobjQxDepartmentInfoEN.departmentTypeId) !=  2)
{
 throw ("(errid:Watl000418)字段[部门类型ID]作为外键字段,长度应该为2(In 部门)!(clsQxDepartmentInfoBL:CheckPropertyNew)");
}
...
*/
export  function QxDepartmentInfo_GetCombineCondition(objQxDepartmentInfoCond: clsQxDepartmentInfoEN ):string
{
//使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
//例如 1 = 1 && UserName = '张三'
let strWhereCond = " 1 = 1 ";
//如果该条件控件的内容不为空,就组成一个条件并添加到总条件串中。
if (Object.prototype.hasOwnProperty.call(objQxDepartmentInfoCond.dicFldComparisonOp, clsQxDepartmentInfoEN.con_DepartmentId) == true)
{
const strComparisonOpDepartmentId:string = objQxDepartmentInfoCond.dicFldComparisonOp[clsQxDepartmentInfoEN.con_DepartmentId];
strWhereCond += Format(" And {0} {2} '{1}'", clsQxDepartmentInfoEN.con_DepartmentId, objQxDepartmentInfoCond.departmentId, strComparisonOpDepartmentId);
}
if (Object.prototype.hasOwnProperty.call(objQxDepartmentInfoCond.dicFldComparisonOp, clsQxDepartmentInfoEN.con_DepartmentName) == true)
{
const strComparisonOpDepartmentName:string = objQxDepartmentInfoCond.dicFldComparisonOp[clsQxDepartmentInfoEN.con_DepartmentName];
strWhereCond += Format(" And {0} {2} '{1}'", clsQxDepartmentInfoEN.con_DepartmentName, objQxDepartmentInfoCond.departmentName, strComparisonOpDepartmentName);
}
if (Object.prototype.hasOwnProperty.call(objQxDepartmentInfoCond.dicFldComparisonOp, clsQxDepartmentInfoEN.con_DepartmentAbbrName) == true)
{
const strComparisonOpDepartmentAbbrName:string = objQxDepartmentInfoCond.dicFldComparisonOp[clsQxDepartmentInfoEN.con_DepartmentAbbrName];
strWhereCond += Format(" And {0} {2} '{1}'", clsQxDepartmentInfoEN.con_DepartmentAbbrName, objQxDepartmentInfoCond.departmentAbbrName, strComparisonOpDepartmentAbbrName);
}
if (Object.prototype.hasOwnProperty.call(objQxDepartmentInfoCond.dicFldComparisonOp, clsQxDepartmentInfoEN.con_DepartmentTypeId) == true)
{
const strComparisonOpDepartmentTypeId:string = objQxDepartmentInfoCond.dicFldComparisonOp[clsQxDepartmentInfoEN.con_DepartmentTypeId];
strWhereCond += Format(" And {0} {2} '{1}'", clsQxDepartmentInfoEN.con_DepartmentTypeId, objQxDepartmentInfoCond.departmentTypeId, strComparisonOpDepartmentTypeId);
}
if (Object.prototype.hasOwnProperty.call(objQxDepartmentInfoCond.dicFldComparisonOp, clsQxDepartmentInfoEN.con_UpDepartmentId) == true)
{
const strComparisonOpUpDepartmentId:string = objQxDepartmentInfoCond.dicFldComparisonOp[clsQxDepartmentInfoEN.con_UpDepartmentId];
strWhereCond += Format(" And {0} {2} '{1}'", clsQxDepartmentInfoEN.con_UpDepartmentId, objQxDepartmentInfoCond.upDepartmentId, strComparisonOpUpDepartmentId);
}
if (Object.prototype.hasOwnProperty.call(objQxDepartmentInfoCond.dicFldComparisonOp, clsQxDepartmentInfoEN.con_OrderNum) == true)
{
const strComparisonOpOrderNum:string = objQxDepartmentInfoCond.dicFldComparisonOp[clsQxDepartmentInfoEN.con_OrderNum];
strWhereCond += Format(" And {0} {2} {1}", clsQxDepartmentInfoEN.con_OrderNum, objQxDepartmentInfoCond.orderNum, strComparisonOpOrderNum);
}
if (Object.prototype.hasOwnProperty.call(objQxDepartmentInfoCond.dicFldComparisonOp, clsQxDepartmentInfoEN.con_InUse) == true)
{
...
if (Object.prototype.hasOwnProperty.call(objQxDepartmentInfoCond.dicFldComparisonOp, clsQxDepartmentInfoEN.con_Memo) == true)
{
const strComparisonOpMemo:string = objQxDepartmentInfoCond.dicFldComparisonOp[clsQxDepartmentInfoEN.con_Memo];
strWhereCond += Format(" And {0} {2} '{1}'", clsQxDepartmentInfoEN.con_Memo, objQxDepartmentInfoCond.memo, strComparisonOpMemo);
}
 return strWhereCond;
}
