...
const strUrl = GetWebApiUrl_GP(qxUserState_Controller, strAction);
...
{
const arrQxUserStateObjLstCache = await QxUserState_GetObjLstCache();
const obj = arrQxUserStateObjLstCache.find(x => x.userStateName == objQxUserState.userStateName);
if (obj != null)
{
 ...
 **/
export  async function QxUserState_GetFldValueAsync(strFldName: string, strWhereCond: string): Promise<Array<string>>  
{
...
let strUrl = GetWebApiUrl_GP(qxUserState_Controller, strAction);
 ...
 **/
export  async function QxUserState_AddNewObjSave(objQxUserStateEN: clsQxUserStateEN): Promise<AddRecordResult>{
 ...
 **/
export  async function QxUserState_CheckUniCond4Add(objQxUserStateEN: clsQxUserStateEN): Promise<boolean>{
 ...
 **/
export  async function QxUserState_CheckUniCond4Update(objQxUserStateEN: clsQxUserStateEN): Promise<boolean>{
 ...
 **/
export  async function QxUserState_UpdateObjSave(objQxUserStateEN: clsQxUserStateEN): Promise<boolean>{
 ...
 * @returns 获取修改是否成功？
 **/
export  async function QxUserState_EditRecordExAsync(objQxUserStateEN: clsQxUserStateEN): Promise<boolean>  
{
...
let arrQxUserStateSel = arrQxUserStateObjLstCache;
if (objQxUserStateCond.GetConditions().length == 0) return arrQxUserStateSel.length>0?true:false;
try {
for (const objCondition of objQxUserStateCond.GetConditions()) {
if (objCondition == null) continue; 
const strKey = objCondition.fldName;
