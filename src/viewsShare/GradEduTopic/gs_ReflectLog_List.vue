...
<th @click = "sortColumn('createDateSim|Ex')">
建立日期
<span>
<i :class="sortColumnKey === 'createDateSim|Ex'? (sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'):'arrow-neutral'"></i>
</span>
</th>
...
日期
<span>
<i :class="sortColumnKey === 'dateTimeSim|Ex'? (sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'):'arrow-neutral'"></i>
</span>
</th>
...
<td v-html="item.reflectLogName"></td>

<td v-html="item.reflectLogContent"></td>

<td v-html="item.createDateSim"></td>
