...
<th @click = "sortColumn('mId')">
mId
<span>
<i :class="sortColumnKey === 'mId'? (sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'):'arrow-neutral'"></i>
</span>
</th>

<th @click = "sortColumn('cacheKey')">
缓存关键字
<span>
<i :class="sortColumnKey === 'cacheKey'? (sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'):'arrow-neutral'"></i>
</span>
</th>

<th @click = "sortColumn('cacheSize')">
缓存大小
<span>
<i :class="sortColumnKey === 'cacheSize'? (sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'):'arrow-neutral'"></i>
</span>
</th>

<th @click = "sortColumn('useDate')">
使用日期
<span>
<i :class="sortColumnKey === 'useDate'? (sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'):'arrow-neutral'"></i>
</span>
</th>
...
备注
<span>
<i :class="sortColumnKey === 'memo'? (sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'):'arrow-neutral'"></i>
</span>
</th>
