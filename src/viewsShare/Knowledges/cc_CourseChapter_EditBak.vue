<template>
  ...
  <el-dialog v-model="dialogVisible" :width="dialogWidth" :show-close="false">
          ...
          <tr id="trIsUse">
            ...
            <td class="text-left" ColSpan="2">
              <span class="form-control form-control-sm" style="width: 150px">
                <input id="chkIsUse" v-model="isUse" type="checkbox" Text="是否使用" /><label
                  for="chkIsUse"
                  >是否使用</label
                ></span
              >
    ...
    <template #footer>
      ...
      <el-button id="btnSubmitcc_CourseChapter" type="primary" @click="btnSubmit_Click">{{
        strSubmitButtonText
      }}</el-button>
    </template>
  </el-dialog>
...
<script lang="ts">
  ...
  import { refDivEdit, CourseId_Session } from '@/viewsShare/Knowledges/cc_CourseChapterVueShare';
