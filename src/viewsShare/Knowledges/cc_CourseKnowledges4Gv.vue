      ...
      <table>
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('questionNum')">
              题目数
              <span v-if="sortColumnKey === 'questionNum'">
                <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
              </span>
            </th>
            ...
            <th @click="sortColumn('knowledgeModuleName')">
              知识点模块
              <span v-if="sortColumnKey === 'knowledgeModuleName'">
                <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
              </span>
            </th>

            <th @click="sortColumn('courseChapterName')">
              课程章节名称
              <span v-if="sortColumnKey === 'courseChapterName'">
                <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
              </span>
            </th>
            ...
            <th @click="sortColumn('knowledgeTypeName')">
              知识点类型名
              <span v-if="sortColumnKey === 'knowledgeTypeName'">
                <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
              </span>
            </th>
            ...
            <th @click="sortColumn('courseId')">
              课程
              <span v-if="sortColumnKey === 'courseId'">
                <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
              </span>
            </th>
