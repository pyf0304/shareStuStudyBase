...
教学班名称
<span>
<i :class="sortColumnKey === 'eduClsName|Ex'? (sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'):'arrow-neutral'"></i>
</span>
</th>
...
课程名称
<span>
<i :class="sortColumnKey === 'courseName'? (sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'):'arrow-neutral'"></i>
</span>
</th>
...
<td>
<input :id="'chk' +  item.structureGraphId"
...
<td v-html="item.structureGraphName"></td>

<td v-html="item.eduClsName"></td>

<td v-html="item.courseId"></td>

<td v-html="item.isDisplay"></td>

<td v-html="item.isExtend"></td>

<td v-html="item.isRecommend"></td>

<td v-html="item.theme"></td>

<td v-html="item.createUser"></td>
...
structureGraphId:item.structureGraphId,
content: '这是当前表的关键字',
});
};
