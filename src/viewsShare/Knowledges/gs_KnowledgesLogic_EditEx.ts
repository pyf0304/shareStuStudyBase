/**
 * 类名:gs_KnowledgesLogic_EditEx(界面:gs_KnowledgesLogicCRUD,01120182)
 * 表名:gs_KnowledgesLogic(01120872)
 * 版本:2025.02.27.1(服务器:WIN-SRV103-116)
 * 日期:2025/03/10 11:17:56
 * 生成者:
 工程名称:问卷调查(0112)
...
/* gs_KnowledgesLogic_EditEx 的摘要说明。其中Q代表查询,U代表修改
  (AutoGCLib.Vue_ViewScript_EditCSEx_TS4TypeScript:GeneCode)
*/
export default class gs_KnowledgesLogic_EditEx extends gs_KnowledgesLogic_Edit {
  /**
 ...
 **/
  public static btnEdit_Click(strCommandName: string, strKeyId: string) {
    ...
    const objPage: gs_KnowledgesLogic_EditEx = <gs_KnowledgesLogic_EditEx>(
      gs_KnowledgesLogic_Edit.GetPageEditObj('gs_KnowledgesLogic_EditEx')
    );
    if (objPage == null) {
      const strMsg = `从预存编辑类获取关键字:[gs_KnowledgesLogic_EditEx]的对象为空，请在调用编辑类(父类)的定义一下！`;
