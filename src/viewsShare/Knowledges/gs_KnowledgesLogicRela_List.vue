      ...
      <table>
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('knowledgeGraphName|Ex')">
              连连看图名
              <span>
                <i
                  :class="
                    sortColumnKey === 'knowledgeGraphName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('relaTypeName|Ex')">
              关系类型名
              <span>
                <i
                  :class="
                    sortColumnKey === 'relaTypeName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('knowledgeNameA|Ex')">
              知识点名称
              <span>
                <i
                  :class="
                    sortColumnKey === 'knowledgeNameA|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('knowledgeTitleA')">
              课程知识点标题A
              <span>
                <i
                  :class="
                    sortColumnKey === 'knowledgeTitleA'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('knowledgeNameB|Ex')">
              知识点名称
              <span>
                <i
                  :class="
                    sortColumnKey === 'knowledgeNameB|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('knowledgeTitleB')">
              课程知识点标题B
              <span>
                <i
                  :class="
                    sortColumnKey === 'knowledgeTitleB'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            ...
            <td v-html="item.knowledgeGraphName"></td>

            <td v-html="item.relaTypeName"></td>

            <td v-html="item.relaTitle"></td>

            <td v-html="item.knowledgeNameA"></td>

            <td v-html="item.knowledgeTitleA"></td>

            <td v-html="item.knowledgeNameB"></td>

            <td v-html="item.knowledgeTitleB"></td>

            <td v-html="item.sourceAnchor"></td>

            <td v-html="item.targetAnchor"></td>
...
<script lang="ts">
  ...
  export default defineComponent({
    name: 'GsKnowledgesLogicRelaList',
    components: {
      // 组件注册
    },
