      ...
      <table>
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('knowledgeNum')">
              知识点数
              <span>
                <i
                  :class="
                    sortColumnKey === 'knowledgeNum'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            ...
            <td v-html="item.knowledgeModuleId"></td>

            <td v-html="item.knowledgeModuleName"></td>

            <td v-html="item.knowledgeModuleContent"></td>

            <td v-html="item.knowledgeNum"></td>
    ...
    setup(props, { emit }) {
      ...
      const btnClickInRow = (item: any) => {
        emit('on-edit-tab-relainfo', {
          knowledgeModuleId: item.knowledgeModuleId,
          content: '这是当前表的关键字',
        });
      };
