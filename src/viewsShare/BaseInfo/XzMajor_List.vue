      ...
      <table>
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('majorTypeName|Ex')">
              专业类型名称
              <span>
                <i
                  :class="
                    sortColumnKey === 'majorTypeName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('xwTypeDesc|Ex')">
              学位类型名称
              <span>
                <i
                  :class="
                    sortColumnKey === 'xwTypeDesc|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            ...
            <td v-html="item.majorId"></td>

            <td v-html="item.majorName"></td>

            <td v-html="item.majorEnglishName"></td>

            <td v-html="item.collegeName"></td>

            <td v-html="item.majorDirection"></td>

            <td v-html="item.majorTypeName"></td>

            <td v-html="item.xwTypeDesc"></td>
