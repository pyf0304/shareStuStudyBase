<template>
  <div id="divLayout" ref="refDivLayout" class="div_layout">
    ...
    <div id="divList" ref="refDivList" class="div_List">
      ...
      <input id="hidSortXzMajorBy" type="hidden" />
    </div>
    <!--编辑层-->
...
<script lang="ts">
  ...
  import XzMajor_ListCom from '@/viewsShare/BaseInfo/XzMajor_List.vue';
  ...
  export default defineComponent({
    ...
    methods: {
      ...
      async EditTabRelaInfo(data: any) {
        ...
        router.push({ name: 'editXzMajor', params: { courseId: data.courseId } });
      },
      ...
      async SortColumn(data: any) {
        console.log('data:', data);
        const objPage = new XzMajorCRUDEx();
