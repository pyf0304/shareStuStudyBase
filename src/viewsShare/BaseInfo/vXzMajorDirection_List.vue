      ...
      <table>
        <tbody>
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            ...
            <td v-html="item.majorDirectionId"></td>

            <td v-html="item.majorName"></td>

            <td v-html="item.majorDirectionName"></td>

            <td v-html="item.majorDirectionENName"></td>
