  ...
  <el-dialog v-model="dialogVisible" :width="dialogWidth" :show-close="false">
    ...
    <template #footer>
      ...
      <el-button
        id="btnSubmitXzMajor"
        type="primary"
        @click="btnXzMajor_Edit_Click('Submit', '')"
...
<script lang="ts">
  ...
  import { XzMajorShoolType_GetObjLstCache } from '@/ts/L3ForWApi/BaseInfo/clsXzMajorShoolTypeWApi';
  ...
  export default defineComponent({
    ...
    setup() {
       ...
       **/
      async function GetEditDataXzMajorObj1() {
        ...
        pobjXzMajorEN.SetIdXzMajorShoolType(idXzMajorShoolType.value); // 专业类型
        pobjXzMajorEN.SetIdXzCollege(idXzCollege.value); // 学院
...
*/
      ...
      async function ShowDataFromXzMajorObj(pobjXzMajorEN: clsXzMajorEN) {
        ...
        idXzMajorShoolType.value = pobjXzMajorEN.idXzMajorShoolType; // 专业类型
        idXzCollege.value = pobjXzMajorEN.idXzCollege; // 学院
