...
*/
export default class StudentInfo_EditEx extends StudentInfo_Edit {
  /**
 ...
 **/
  public static btnEdit_Click(strCommandName: string, strKeyId: string) {
    ...
    if (objPage == null) {
      const strMsg = `从预存编辑类获取关键字:[StudentInfo_EditEx]的对象为空，请在调用编辑类(父类)的定义一下！`;
