      ...
      <table>
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('stuName')">
              姓名
              <span>
                <i
                  :class="
                    sortColumnKey === 'stuName'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('sexDesc|Ex')">
              性别
              <span>
                <i
                  :class="
                    sortColumnKey === 'sexDesc|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('gradeBaseName|Ex')">
              入学年级
              <span>
                <i
                  :class="
                    sortColumnKey === 'gradeBaseName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            ...
            <td v-html="item.sexDesc"></td>

            <td v-html="item.gradeBaseName"></td>
