      ...
      <table>
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('stuId|Ex')">
              学号
              <span>
                <i
                  :class="
                    sortColumnKey === 'stuId|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('stuName|Ex')">
              姓名
              <span>
                <i
                  :class="
                    sortColumnKey === 'stuName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('gradeName|Ex')">
              年级名称
              <span>
                <i
                  :class="
                    sortColumnKey === 'gradeName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('adminClsName|Ex')">
              行政班名称
              <span>
                <i
                  :class="
                    sortColumnKey === 'adminClsName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('majorName|Ex')">
              专业名称
              <span>
                <i
                  :class="
                    sortColumnKey === 'majorName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('courseCode|Ex')">
              课程代码
              <span>
                <i
                  :class="
                    sortColumnKey === 'courseCode|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('courseTypeName|Ex')">
              课程类型
              <span>
                <i
                  :class="
                    sortColumnKey === 'courseTypeName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            ...
            <td v-html="item.stuId"></td>

            <td v-html="item.stuName"></td>

            <td v-html="item.gradeName"></td>

            <td v-html="item.adminClsName"></td>
            ...
            <td v-html="item.schoolYear"></td>

            <td v-html="item.schoolTerm"></td>
          </tr> </tbody
      ></table>
    </template>
  </div>
