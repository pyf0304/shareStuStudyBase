/**
 * 类名:gs_TeachingDate_EditEx(界面:gs_TeachingDateCRUD,01120139)
 * 表名:gs_TeachingDate(01120684)
 * 版本:2024.11.13.1(服务器:WIN-SRV103-116)
 * 日期:2024/11/13 06:35:47
 * 生成者:
 工程名称:问卷调查(0112)
...
*/
export default class gs_TeachingDate_EditEx extends gs_TeachingDate_Edit {
  /**
 ...
 **/
  public static btnEdit_Click(strCommandName: string, strKeyId: string) {
    ...
    if (objPage == null) {
      const strMsg = `从预存编辑类获取关键字:[gs_TeachingDate_EditEx]的对象为空，请在调用编辑类(父类)的定义一下！`;
