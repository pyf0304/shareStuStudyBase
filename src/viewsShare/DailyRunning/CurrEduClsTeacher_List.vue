      ...
      <table>
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('eduClsName')">
              教学班名
              <span>
                <i
                  :class="
                    sortColumnKey === 'eduClsName'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('teacherName')">
              教师姓名
              <span>
                <i
                  :class="
                    sortColumnKey === 'teacherName'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('collegeName')">
              学院名
              <span>
                <i
                  :class="
                    sortColumnKey === 'collegeName'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
