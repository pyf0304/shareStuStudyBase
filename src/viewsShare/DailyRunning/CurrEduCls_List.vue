      ...
      <table>
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('userTypeNameSim|Ex')">
              用户类型
              <span>
                <i
                  :class="
                    sortColumnKey === 'userTypeNameSim|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            ...
            <td v-html="item.currEduClsId"></td>
            ...
            <td v-html="item.userTypeNameSim"></td>
            ...
            <td v-html="item.classRoomTypeDesc"></td>

            <td v-html="item.modifyDate"></td>

            <td v-html="item.modifyUserId"></td>
          </tr> </tbody
      ></table>
    </template>
  </div>
