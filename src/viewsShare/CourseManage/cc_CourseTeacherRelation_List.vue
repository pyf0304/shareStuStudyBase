      ...
      <table>
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('teacherId|Ex')">
              教师工号
              <span>
                <i
                  :class="
                    sortColumnKey === 'teacherId|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('teacherName|Ex')">
              教师姓名
              <span>
                <i
                  :class="
                    sortColumnKey === 'teacherName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            <td>
              <input
                :id="'chk' + item.courseTeacherRelationId"
            ...
            <td v-html="item.teacherId"></td>

            <td v-html="item.teacherName"></td>

            <td v-html="item.isCourseManager"></td>

            <td v-html="item.lastVisitedDate"></td>
...
<script lang="ts">
  ...
  export default defineComponent({
    name: 'CcCourseTeacherRelationList',
    components: {
      // 组件注册
    },
    ...
    setup(props, { emit }) {
      ...
      const btnClickInRow = (item: any) => {
        emit('on-edit-tab-relainfo', {
          courseTeacherRelationId: item.courseTeacherRelationId,
          content: '这是当前表的关键字',
        });
      };
