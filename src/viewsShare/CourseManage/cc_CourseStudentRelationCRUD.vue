  ...
  <div id="divLayout" ref="refDivLayout" class="div_layout">
    ...
    <div id="divFunction" ref="refDivFunction" class="table table-bordered table-hover">
      <ul class="nav">
        <li class="nav-item">
          <label
            id="lblcc_CourseStudentRelationList"
            name="lblcc_CourseStudentRelationList"
    ...
    <div id="divList" ref="refDivList" class="div_List">
      <cc_CourseStudentRelation_ListCom
        ref="refcc_CourseStudentRelation_List"
        :items="dataListcc_CourseStudentRelation"
      ...
      <input id="hidSortcc_CourseStudentRelationBy" type="hidden" />
    </div>
    <!--编辑层-->
    <cc_CourseStudentRelation_EditCom
      ref="refcc_CourseStudentRelation_Edit"
    ></cc_CourseStudentRelation_EditCom>
  </div>
</template>
<script lang="ts">
  ...
  import {
    ...
    showErrorMessage,
    dataListcc_CourseStudentRelation,
    emptyRecNumInfo,
    dataColumn,
    CourseId_Session,
    courseId_q,
  ...
  import cc_CourseStudentRelationCRUDEx from '@/viewsShare/CourseManage/cc_CourseStudentRelationCRUDEx';
  import cc_CourseStudentRelation_EditCom from '@/viewsShare/CourseManage/cc_CourseStudentRelation_Edit.vue';
  import cc_CourseStudentRelation_ListCom from '@/viewsShare/CourseManage/cc_CourseStudentRelation_List.vue';
  ...
  export default defineComponent({
    name: 'Cc_CourseStudentRelationCRUD',
    components: {
      // 组件注册
      cc_CourseStudentRelation_EditCom,
      cc_CourseStudentRelation_ListCom,
    ...
    setup() {
      ...
      const objPage = ref<cc_CourseStudentRelationCRUDEx>();
      const objPage_Edit = ref<cc_CourseStudentRelation_EditEx>();
      const opType = ref('');
      const thisConstructorName = 'Cc_CourseStudentRelationCRUD';
      ...
      const btnQuery_Click = async () => {
        ...
        await objPage.value.BindGv_cc_CourseStudentRelation4Func(refDivList.value);
      };
      ...
      const btnCreate_Click = async () => {
        ...
        objPage_Edit.value = new cc_CourseStudentRelation_EditEx(
          'cc_CourseStudentRelation_EditEx',
          objPage.value,
        );
        ...
        try {
          opType.value = 'Add';
          const bolIsSuccess = await objPage_Edit.value.ShowDialog_cc_CourseStudentRelation(
            opType.value,
          );
      ...
      const btnUpdate_Click = async () => {
        ...
        const lngCourseStudentRelationId = Number(strFstKeyId);
      ...
      const btnDelete_Click = async () => {
        ...
        try {
          ...
          await objPage.value.BindGv_cc_CourseStudentRelation4Func(divVarSet.refDivList);
        } catch (e) {
      ...
      const btnExportExcel_Click = async () => {
        ...
        const objExportExcelData: ExportExcelData =
          await objPage.value.ExportExcel_cc_CourseStudentRelation4Func();
      ...
      onMounted(async () => {
        ...
        cc_CourseStudentRelationCRUDEx.vuebtn_Click = btn_Click;
        cc_CourseStudentRelationCRUDEx.GetPropValue = GetPropValue;
        objPage.value = new cc_CourseStudentRelationCRUDEx();
      ...
      function btn_Click(strCommandName: string, strKeyId: string) {
        ...
        cc_CourseStudentRelationCRUDEx.btn_Click(strCommandName, strKeyId);
      }
      return {
        showErrorMessage,
        dataListcc_CourseStudentRelation,
    ...
    methods: {
      ...
      async EditTabRelaInfo(data: any) {
        ...
        router.push({ name: 'editcc_CourseStudentRelation', params: { courseId: data.courseId } });
      },
      ...
      async SortColumn(data: any) {
        console.log('data:', data);
        const objPage = new cc_CourseStudentRelationCRUDEx();
