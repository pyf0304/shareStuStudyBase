      ...
      <table>
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('usedCredits')">
              已用积分
              <span>
                <i
                  :class="
                    sortColumnKey === 'usedCredits'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('getDate')">
              获取日期
              <span>
                <i
                  :class="
                    sortColumnKey === 'getDate'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('getInstructions')">
              获取说明
              <span>
                <i
                  :class="
                    sortColumnKey === 'getInstructions'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('badgeNum')">
              徽章数量
              <span>
                <i
                  :class="
                    sortColumnKey === 'badgeNum'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            <td>
              <input
                :id="'chk' + item.idCurrEduCls + item.userId"
            ...
            <td v-html="item.usedCredits"></td>

            <td v-html="item.passed"></td>

            <td v-html="item.getDate"></td>

            <td v-html="item.getInstructions"></td>

            <td v-html="item.badgeNum"></td>
