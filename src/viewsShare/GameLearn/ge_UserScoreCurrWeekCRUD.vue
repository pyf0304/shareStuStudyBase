  ...
  <div id="divLayout" ref="refDivLayout" class="div_layout">
    ...
    <div id="divFunction" ref="refDivFunction" class="table table-bordered table-hover">
      <ul class="nav">
        <li class="nav-item">
          <label
            id="lblge_UserScoreCurrWeekList"
            name="lblge_UserScoreCurrWeekList"
    ...
    <div id="divList" ref="refDivList" class="div_List">
      <ge_UserScoreCurrWeek_ListCom
        ref="refge_UserScoreCurrWeek_List"
        :items="dataListge_UserScoreCurrWeek"
      ...
      <input id="hidSortge_UserScoreCurrWeekBy" type="hidden" />
    </div>
  </div>
</template>
<script lang="ts">
  ...
  import {
    ...
    userId_q,
    passed_q,
  } from '@/viewsShare/GameLearn/ge_UserScoreCurrWeekVueShare';
  ...
  import ge_UserScoreCurrWeekCRUDEx from '@/viewsShare/GameLearn/ge_UserScoreCurrWeekCRUDEx';
  import ge_UserScoreCurrWeek_ListCom from '@/viewsShare/GameLearn/ge_UserScoreCurrWeek_List.vue';
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      if (CourseId_Session.value == '') {
        CourseId_Session.value = '00000041';
      }
      if (IdCurrEduCls_Session.value == '') {
        IdCurrEduCls_Session.value = '00000059';
      }

      const objPage = ref<ge_UserScoreCurrWeekCRUDEx>();
      const opType = ref('');
      const thisConstructorName = 'Ge_UserScoreCurrWeekCRUD';
      ...
      const btnQuery_Click = async () => {
        ...
        await objPage.value.BindGv_ge_UserScoreCurrWeek4Func(refDivList.value);
      };
      ...
      const btnDelete_Click = async () => {
        ...
        try {
          ...
          await objPage.value.BindGv_ge_UserScoreCurrWeek4Func(divVarSet.refDivList);
        } catch (e) {
      ...
      const strTitle = ref('用户当前周得分维护');
      onMounted(async () => {
        try {
          await BindDdl4QryRegion();
          await BindDdl4FeatureRegion();
          ge_UserScoreCurrWeekCRUDEx.vuebtn_Click = btn_Click;
          ge_UserScoreCurrWeekCRUDEx.GetPropValue = GetPropValue;
          objPage.value = new ge_UserScoreCurrWeekCRUDEx();
      ...
      function btn_Click(strCommandName: string, strKeyId: string) {
        ...
        ge_UserScoreCurrWeekCRUDEx.btn_Click(strCommandName, strKeyId);
      }
      return {
        showErrorMessage,
        dataListge_UserScoreCurrWeek,
    ...
    methods: {
      ...
      async EditTabRelaInfo(data: any) {
        ...
        router.push({ name: 'editge_UserScoreCurrWeek', params: { courseId: data.courseId } });
      },
      ...
      async SortColumn(data: any) {
        console.log('data:', data);
        const objPage = new ge_UserScoreCurrWeekCRUDEx();
