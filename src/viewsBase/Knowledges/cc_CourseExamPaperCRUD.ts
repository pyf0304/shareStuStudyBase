...
import { CourseId_Session,Combinecc_CourseExamPaperConditionObj4ExportExcel,Combinecc_CourseExamPaperConditionObj,divVarSet,viewVarSet,dataColumn,BindTabByList,refcc_CourseExamPaper_List } from "@/viewsShare/Knowledges/cc_CourseExamPaperVueShare";
import { cc_CourseExamPaper_GetRecCountByCondCache,cc_CourseExamPaper_GetSubObjLstCache,cc_CourseExamPaper_DelRecordAsync,cc_CourseExamPaper_ReFreshCache,cc_CourseExamPaper_GetObjByCourseExamPaperIdAsync,cc_CourseExamPaper_FuncMapByFldName,cc_CourseExamPaper_GetObjExLstByPagerCache,cc_CourseExamPaper_GetObjLstByCourseExamPaperIdLstAsync,cc_CourseExamPaper_GetMaxStrIdAsync,cc_CourseExamPaper_AddNewRecordAsync,cc_CourseExamPaper_Delcc_CourseExamPapersAsync } from "@/ts/L3ForWApi/Knowledges/clscc_CourseExamPaperWApi";
...
if (viewVarSet.sortcc_CourseExamPaperBy == '') viewVarSet.sortcc_CourseExamPaperBy = `${ clscc_CourseExamPaperEN.con_CourseId } Asc`;
 ...
 **/
public CombineData(arrcc_CourseExamPaperObjLst: Array<clscc_CourseExamPaperEN>, arrDataColumn: Array<clsDataColumn>): ExportExcelData 
{
...
const strFileName = Format("考卷({0})导出.xlsx",
 clscc_CourseExamPaperEN._CurrTabName);
const strSheetName = "考卷列表";
 ...
 **/
public async ExportExcel_cc_CourseExamPaperCache(): Promise<ExportExcelData> 
{
const strThisFuncName = this.ExportExcel_cc_CourseExamPaperCache.name;
if (viewVarSet.sortcc_CourseExamPaperBy == null)
{
const strMsg = Format("在显示列表时,排序字段(sortcc_CourseExamPaperBy)为空,请检查!(In BindGv_cc_CourseExamPaperCache)");
...
this.recCount = await cc_CourseExamPaper_GetRecCountByCondCache(objcc_CourseExamPaperCond ,CourseId_Session.value);
if (this.recCount == 0)
{
const strMsg = Format("在绑定GvCache过程中,根据条件:[{0}]获取的对象列表数为0!", objcc_CourseExamPaperCond.whereCond);
console.error("Error: ", strMsg);
//console.trace();
alert(strMsg);
return { arrObjLst: [], sheetName: '', fileName: '' };
...
arrcc_CourseExamPaperObjLst = await cc_CourseExamPaper_GetSubObjLstCache(objcc_CourseExamPaperCond ,CourseId_Session.value);
}
catch(e)
{
...
{
const strKey = Format("{0}_{1}", clscc_CourseExamPaperEN._CurrTabName, CourseId_Session.value);
...
arrcc_CourseExamPaperObjLst = arrcc_CourseExamPaperObjLst.sort(this.SortFunExportExcel);
 return this.CombineData(arrcc_CourseExamPaperObjLst, arrDataColumn); 
 ...
 **/
public async BindTab_cc_CourseExamPaper(divContainer: HTMLDivElement, arrcc_CourseExamPaperExObjLst: Array<clscc_CourseExamPaperENEx>) 
{
...
await BindTab(divDataLst, arrcc_CourseExamPaperExObjLst, arrDataColumn,  clscc_CourseExamPaperEN.con_CourseExamPaperId, this); 
}
 ...
 **/
public async BindTab_cc_CourseExamPaper4Func(divContainer: HTMLDivElement, arrcc_CourseExamPaperExObjLst: Array<clscc_CourseExamPaperENEx>) 
{
 ...
 **/
public async ExtendFldFuncMap(arrcc_CourseExamPaperExObjLst: Array<clscc_CourseExamPaperENEx>, arrDataColumn: Array<clsDataColumn>) {
...
await cc_CourseExamPaper_FuncMapByFldName(objDataColumn.fldName, objInFor);
}
}
}
...
lblMsg.innerHTML = Format("根据条件:[{0}]获取的对象列表数为0!", objcc_CourseExamPaperCond.whereCond);
const strMsg = Format("在绑定GvCache过程中,根据条件:[{0}]获取的对象列表数为0!", objcc_CourseExamPaperCond.whereCond);
console.error("Error: ", strMsg);
//console.trace();
alert(strMsg);
...
conditionCollection: objcc_CourseExamPaperCond,
orderBy: viewVarSet.sortcc_CourseExamPaperBy,
sortFun: strSortFun
}
arrcc_CourseExamPaperExObjLst = await cc_CourseExamPaper_GetObjExLstByPagerCache(objPagerPara ,CourseId_Session.value);
}
catch(e)
{
const strMsg = `绑定GridView不成功,${e}.(in ${this.constructor.name}.${strThisFuncName}`;
...
const { sortFun, ascOrDesc4SortFun, sortBy } = GetSortBy(objAnchorElement, viewVarSet.ascOrDesc4SortFun, viewVarSet.sortcc_CourseExamPaperBy, strSortExpress);
// 将 sortBy 按空格分成两部分
const [sortColumnKey, sortDirection] = sortBy.split(' ');
if (Object.prototype.hasOwnProperty.call(clscc_CourseExamPaperENEx, sortColumnKey))
{
// 调用 SortColumn 函数
...
try
{
const arrcc_CourseExamPaperObjLst = await cc_CourseExamPaper_GetObjLstByCourseExamPaperIdLstAsync(arrCourseExamPaperId);
 ...
 **/
public Showcc_CourseExamPaperObj(divContainer: HTMLDivElement, objcc_CourseExamPaper: clscc_CourseExamPaperEN) 
{
if (divContainer == null)
{
