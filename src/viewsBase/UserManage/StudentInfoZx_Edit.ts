 ...
 /**
 * 类名:StudentInfoZx_Edit(界面:StudentInfoZxCRUD,01120257)
 * 表名:StudentInfo(01120131)
 * 版本:2025.06.10.1(服务器:WIN-SRV103-116)
 * 日期:2025/06/11 00:33:04
 * 生成者:
 工程名称:问卷调查(0112)
...
import { StudentInfo_GetMaxStrIdAsync,StudentInfo_CheckPropertyNew,StudentInfo_AddNewRecordWithMaxIdAsync,StudentInfo_GetUniCondStr,StudentInfo_IsExistRecordAsync,StudentInfo_GetUniCondStr4Update,StudentInfo_IsExistAsync,StudentInfo_GetObjByIdStudentInfoAsync,StudentInfo_CheckProperty4Update,StudentInfo_UpdateRecordAsync,StudentInfo_EditRecordExAsync } from "@/ts/L3ForWApi/UserManage/clsStudentInfoWApi";
import { clsStudentInfoEN } from "@/ts/L0Entity/UserManage/clsStudentInfoEN";
import { divVarSet,refStudentInfoZx_Edit } from "@/viewsShare/UserManage/StudentInfoZxCRUDVueShare";
import { IShowList } from "@/ts/PubFun/IShowList";
import { enumPageDispMode } from "@/ts/PubFun/enumPageDispMode";
 /** StudentInfoZx_Edit 的摘要说明。其中Q代表查询,U代表修改
 * (AutoGCLib.Vue_ViewScript_EditCS_TS4TypeScript:GeneCode)
 **/
export abstract class  StudentInfoZx_Edit 
{
...
public static objPageEdit: StudentInfoZx_Edit;
public static objPageEdit2: StudentInfoZx_Edit;
public static objPageEdit3: StudentInfoZx_Edit;
...
if (StudentInfoZx_Edit.SetPageEdit(this, 1) == true) return;
if (StudentInfoZx_Edit.SetPageEdit(this, 2) == true) return;
if (StudentInfoZx_Edit.SetPageEdit(this, 3) == true) return;
}
...
{
case 1:
if (StudentInfoZx_Edit.objPageEdit == null)
{
StudentInfoZx_Edit.objPageEdit = objDataLst;
return true;
}
else
{
const strClassNameOld = StudentInfoZx_Edit.objPageEdit.className;
...
break;
case 2:
if (StudentInfoZx_Edit.objPageEdit2 == null)
{
StudentInfoZx_Edit.objPageEdit2 = objDataLst;
return true;
}
else
{
const strClassNameOld = StudentInfoZx_Edit.objPageEdit2.className;
if (strClassNameOld == strNewClassName)
{
StudentInfoZx_Edit.objPageEdit2 = objDataLst;
return true;
...
break;
case 3:
if (StudentInfoZx_Edit.objPageEdit3 == null)
{
StudentInfoZx_Edit.objPageEdit3 = objDataLst;
return true;
}
else
{
const strClassNameOld = StudentInfoZx_Edit.objPageEdit3.className;
if (strClassNameOld == strNewClassName)
{
StudentInfoZx_Edit.objPageEdit3 = objDataLst;
return true;
...
{
const strClassNameOld = StudentInfoZx_Edit.objPageEdit.className;
if (strClassNameOld == strClassName) return StudentInfoZx_Edit.objPageEdit;
}
if (StudentInfoZx_Edit.objPageEdit2 != null)
{
const strClassNameOld = StudentInfoZx_Edit.objPageEdit2.className;
if (strClassNameOld == strClassName) return StudentInfoZx_Edit.objPageEdit2;
}
if (StudentInfoZx_Edit.objPageEdit3 != null)
{
const strClassNameOld = StudentInfoZx_Edit.objPageEdit3.className;
if (strClassNameOld == strClassName) return StudentInfoZx_Edit.objPageEdit3;
}
return null;
}
...
if (StudentInfoZx_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01)
{
 refStudentInfoZx_Edit.value.hideDialog();
}
}
...
if (StudentInfoZx_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01)
{
if (refStudentInfoZx_Edit.value == null)
{
const strMsg = Format(
...
await refStudentInfoZx_Edit.value.showDialog(this);
}
 ...
 **/
public async btnUpdateRecordInTab_Click(strIdStudentInfo: string) {
...
const bolIsSuccess = await this.ShowDialog_StudentInfo(this.opType);
if (bolIsSuccess == false) return;
this.UpdateRecord(strIdStudentInfo);
}
catch (e)
{
 ...
 **/
public async btnUpdateRecord_Click(strIdStudentInfo: string) {
...
const update = await this.UpdateRecord(strIdStudentInfo);
if (update == false)
{
...
if (this.iShowList != null) this.iShowList.BindGv(clsStudentInfoEN._CurrTabName, returnKeyId);
}
}
else
{
...
if (this.iShowList != null) this.iShowList.BindGv(clsStudentInfoEN._CurrTabName, this.keyId);
}
}
break;
case "确认修改":
...
strInfo += "(In StudentInfoZx_Edit.btnSubmit_Click)";
//显示信息框
//console.log(strInfo);
alert(strInfo);
if (returnBool == true)
...
refStudentInfoZx_Edit.value.Clear();
...
let objStudentInfoEN;
try
{
objStudentInfoEN = await refStudentInfoZx_Edit.value.GetEditDataStudentInfoObj();
}
catch(e)
{
...
const strInfo = `添加[学生(StudentInfo)]记录成功!`;
//显示信息框
...
console.error(strMsg);
        ...
        //3、用提供的关键字初始化一个类对象；
refStudentInfoZx_Edit.value.ShowDataFromStudentInfoObj(objStudentInfoEN);
}
...
await refStudentInfoZx_Edit.value.ShowDataFromStudentInfoObj(objStudentInfoEN);
...
const objStudentInfoEN = await refStudentInfoZx_Edit.value.GetEditDataStudentInfoObj();
...
{
//StudentInfo_ReFreshCache();
//StudentInfo_DeleteKeyIdCache(this.keyId);
}
return returnBool;
}
catch(e)
...
const returnBool = await StudentInfo_EditRecordExAsync(objStudentInfoEN);
if (returnBool == true)
{
//StudentInfo_ReFreshCache();
}
...
refStudentInfoZx_Edit.value.strCancelButtonText = value;
}
 /**
 * 获取按钮的标题
 **/
public  get btnSubmitStudentInfo():string {
const strValue = refStudentInfoZx_Edit.value.strSubmitButtonText;
return strValue;
}
 /**
...
refStudentInfoZx_Edit.value.strSubmitButtonText = value;
}
}