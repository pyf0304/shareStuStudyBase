...
{
refCacheUseState_Edit.value.hideDialog();
if (this.iShowList != null) this.iShowList.BindGvCache(clsCacheUseStateEN._CurrTabName, "");
}
}
else
{
...
if (this.iShowList != null) this.iShowList.BindGvCache(clsCacheUseStateEN._CurrTabName, this.keyId.toString());
}
}
break;
case "确认修改":
